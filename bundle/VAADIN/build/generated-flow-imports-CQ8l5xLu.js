import{f as Fs,S as Ds,i as m,b as y,a as x,A as Ti,c as ki,t as J,e as Ri,E as Te,D as Ft,_ as $s,r as C,d as we,g as Ns,j as Bs,O as Vs}from"./indexhtml-xNE8g4ED.js";import"./commonjsHelpers-CqkleIqs.js";/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */window.Vaadin||={};window.Vaadin.featureFlags||={};function Hs(s){return s.replace(/-[a-z]/gu,i=>i[1].toUpperCase())}const j={};function b(s,i="25.0.3"){if(Object.defineProperty(s,"version",{get(){return i}}),s.experimental){const t=typeof s.experimental=="string"?s.experimental:`${Hs(s.is.split("-").slice(1).join("-"))}Component`;if(!window.Vaadin.featureFlags[t]&&!j[t]){j[t]=new Set,j[t].add(s),Object.defineProperty(window.Vaadin.featureFlags,t,{get(){return j[t].size===0},set(n){n&&j[t].size>0&&(j[t].forEach(r=>{customElements.define(r.is,r)}),j[t].clear())}});return}else if(j[t]){j[t].add(s);return}}const e=customElements.get(s.is);if(!e)customElements.define(s.is,s);else{const t=e.version;t&&s.version&&t===s.version?console.warn(`The component ${s.is} has been loaded twice`):console.error(`Tried to define ${s.is} version ${s.version} when version ${e.version} is already in use. Something will probably break.`)}}const qs=/\/\*[\*!]\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,qe=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function Ws(){function s(){return!0}return Oi(s)}function Us(){try{return js()?!0:Gs()?qe?!Ks():!Ws():!1}catch{return!1}}function js(){return localStorage.getItem("vaadin.developmentmode.force")}function Gs(){return["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0}function Ks(){return!!(qe&&Object.keys(qe).map(i=>qe[i]).filter(i=>i.productionMode).length>0)}function Oi(s,i){if(typeof s!="function")return;const e=qs.exec(s.toString());if(e)try{s=new Function(e[1])}catch(t){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",t)}return s(i)}window.Vaadin=window.Vaadin||{};const ii=function(s,i){if(window.Vaadin.developmentMode)return Oi(s,i)};window.Vaadin.developmentMode===void 0&&(window.Vaadin.developmentMode=Us());function Ys(){/*! vaadin-dev-mode:start
  (function () {
'use strict';
...
try {
  ...
  vaadin-dev-mode:end **/}const Xs=function(){if(typeof ii=="function")return ii(Ys)};/**
 * @license
 ...
 */let si=0,zi=0;const pe=[];let At=!1;function Zs(){At=!1;const s=pe.length;for(let i=0;i<s;i++){const e=pe[i];if(e)try{e()}catch(t){setTimeout(()=>{throw t})}}pe.splice(0,s),zi+=s}const H={after(s){return{run(i){return window.setTimeout(i,s)},cancel(i){window.clearTimeout(i)}}},run(s,i){return window.setTimeout(s,i)},cancel(s){window.clearTimeout(s)}},Y={run(s){return window.requestAnimationFrame(s)},cancel(s){window.cancelAnimationFrame(s)}},Li={run(s){return window.requestIdleCallback?window.requestIdleCallback(s):window.setTimeout(s,16)},cancel(s){window.cancelIdleCallback?window.cancelIdleCallback(s):window.clearTimeout(s)}},q={run(s){At||(At=!0,queueMicrotask(()=>Zs())),pe.push(s);const i=si;return si+=1,i},cancel(s){const i=s-zi;if(i>=0){if(!pe[i])throw new Error(`invalid async handle: ${s}`);pe[i]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Oe=new Set;class S{static debounce(i,e,t){return i instanceof S?i._cancelAsync():i=new S,i.setConfig(e,t),i}constructor(){this._asyncModule=null,this._callback=null,this._timer=null}setConfig(i,e){this._asyncModule=i,this._callback=e,this._timer=this._asyncModule.run(()=>{this._timer=null,Oe.delete(this),this._callback()})}cancel(){this.isActive()&&(this._cancelAsync(),Oe.delete(this))}_cancelAsync(){this.isActive()&&(this._asyncModule.cancel(this._timer),this._timer=null)}flush(){this.isActive()&&(this.cancel(),this._callback())}isActive(){return this._timer!=null}}function Pi(s){Oe.add(s)}function Qs(){const s=!!Oe.size;return Oe.forEach(i=>{try{i.flush()}catch(e){setTimeout(()=>{throw e})}}),s}const ke=()=>{let s;do s=Qs();while(s)};/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const G=[];function Tt(s,i,e=s.getAttribute("dir")){i?s.setAttribute("dir",i):e!=null&&s.removeAttribute("dir")}function kt(){return document.documentElement.getAttribute("dir")}function Js(){const s=kt();G.forEach(i=>{Tt(i,s)})}const en=new MutationObserver(Js);en.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const $=s=>class extends s{static get properties(){return{dir:{type:String,value:"",reflectToAttribute:!0,converter:{fromAttribute:e=>e||"",toAttribute:e=>e===""?null:e}}}}get __isRTL(){return this.getAttribute("dir")==="rtl"}connectedCallback(){super.connectedCallback(),(!this.hasAttribute("dir")||this.__restoreSubscription)&&(this.__subscribe(),Tt(this,kt(),null))}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e!=="dir")return;const r=kt(),o=n===r&&G.indexOf(this)===-1,a=!n&&t&&G.indexOf(this)===-1;o||a?(this.__subscribe(),Tt(this,r,n)):n!==r&&t===r&&this.__unsubscribe()}disconnectedCallback(){super.disconnectedCallback(),this.__restoreSubscription=G.includes(this),this.__unsubscribe()}_valueToNodeAttribute(e,t,n){n==="dir"&&t===""&&!e.hasAttribute("dir")||super._valueToNodeAttribute(e,t,n)}_attributeToProperty(e,t,n){e==="dir"&&!t?this.dir="":super._attributeToProperty(e,t,n)}__subscribe(){G.includes(this)||G.push(this)}__unsubscribe(){G.includes(this)&&G.splice(G.indexOf(this),1)}};/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */window.Vaadin||(window.Vaadin={});window.Vaadin.registrations||(window.Vaadin.registrations=[]);window.Vaadin.developmentModeCallback||(window.Vaadin.developmentModeCallback={});window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=function(){Xs()};let pt;const ni=new Set,P=s=>class extends $(s){static finalize(){super.finalize();const{is:e}=this;if(e&&!ni.has(e)){window.Vaadin.registrations.push(this),ni.add(e);const t=window.Vaadin.developmentModeCallback;t&&(pt=S.debounce(pt,Li,()=>{t["vaadin-usage-statistics"]()}),Pi(pt))}}constructor(){super(),document.doctype===null&&console.warn('Vaadin components require the "standards mode" declaration. Please add <!DOCTYPE html> to the HTML document.')}},Mi=new WeakMap;function tn(s,i){let e=i;for(;e;){if(Mi.get(e)===s)return!0;e=Object.getPrototypeOf(e)}return!1}function N(s){return i=>{if(tn(s,i))return i;const e=s(i);return Mi.set(e,s),e}}/**
 * @license
 * Copyright (c) 2023 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function je(s,i){return s.split(".").reduce((e,t)=>e?e[t]:void 0,i)}function sn(s,i,e){const t=s.split("."),n=t.pop(),r=t.reduce((o,a)=>o[a],e);r[n]=i}/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ft={},nn=/([A-Z])/gu;function ri(s){return ft[s]||(ft[s]=s.replace(nn,"-$1").toLowerCase()),ft[s]}function oi(s){return s[0].toUpperCase()+s.substring(1)}function gt(s){const[i,e]=s.split("("),t=e.replace(")","").split(",").map(n=>n.trim());return{method:i,observerProps:t}}function vt(s,i){return Object.prototype.hasOwnProperty.call(s,i)||(s[i]=new Map(s[i])),s[i]}const rn=s=>{class i extends s{static enabledWarnings=[];static createProperty(t,n){[String,Boolean,Number,Array].includes(n)&&(n={type:n}),n&&n.reflectToAttribute&&(n.reflect=!0),super.createProperty(t,n)}static getOrCreateMap(t){return vt(this,t)}static finalize(){if(window.litIssuedWarnings&&(window.litIssuedWarnings.add("no-override-create-property"),window.litIssuedWarnings.add("no-override-get-property-descriptor")),super.finalize(),Array.isArray(this.observers)){const t=this.getOrCreateMap("__complexObservers");this.observers.forEach(n=>{const{method:r,observerProps:o}=gt(n);t.set(r,o)})}}static addCheckedInitializer(t){super.addInitializer(n=>{n instanceof this&&t(n)})}static getPropertyDescriptor(t,n,r){const o=super.getPropertyDescriptor(t,n,r);let a=o;if(this.getOrCreateMap("__propKeys").set(t,n),r.sync&&(a={get:o.get,set(l){const h=this[t];Fs(l,h)&&(this[n]=l,this.requestUpdate(t,h,r),this.hasUpdated&&this.performUpdate())},configurable:!0,enumerable:!0}),r.readOnly){const l=a.set;this.addCheckedInitializer(h=>{h[`_set${oi(t)}`]=function(_){l.call(h,_)}}),a={get:a.get,set(){},configurable:!0,enumerable:!0}}if("value"in r&&this.addCheckedInitializer(l=>{const h=typeof r.value=="function"?r.value.call(l):r.value;r.readOnly?l[`_set${oi(t)}`](h):l[t]=h}),r.observer){const l=r.observer;this.getOrCreateMap("__observers").set(t,l),this.addCheckedInitializer(h=>{h[l]||console.warn(`observer method ${l} not defined`)})}if(r.notify){if(!this.__notifyProps)this.__notifyProps=new Set;else if(!this.hasOwnProperty("__notifyProps")){const l=this.__notifyProps;this.__notifyProps=new Set(l)}this.__notifyProps.add(t)}if(r.computed){const l=`__assignComputed${t}`,h=gt(r.computed);this.prototype[l]=function(..._){this[t]=this[h.method](..._)},this.getOrCreateMap("__computedObservers").set(l,h.observerProps)}return r.attribute||(r.attribute=ri(t)),a}static get polylitConfig(){return{asyncFirstRender:!1}}connectedCallback(){super.connectedCallback();const{polylitConfig:t}=this.constructor;!this.hasUpdated&&!t.asyncFirstRender&&this.performUpdate()}firstUpdated(){super.firstUpdated(),this.$||(this.$={}),this.renderRoot.querySelectorAll("[id]").forEach(t=>{this.$[t.id]=t})}ready(){}willUpdate(t){this.constructor.__computedObservers&&this.__runComplexObservers(t,this.constructor.__computedObservers)}updated(t){const n=this.__isReadyInvoked;this.__isReadyInvoked=!0,this.constructor.__observers&&this.__runObservers(t,this.constructor.__observers),this.constructor.__complexObservers&&this.__runComplexObservers(t,this.constructor.__complexObservers),this.__dynamicPropertyObservers&&this.__runDynamicObservers(t,this.__dynamicPropertyObservers),this.__dynamicMethodObservers&&this.__runComplexObservers(t,this.__dynamicMethodObservers),this.constructor.__notifyProps&&this.__runNotifyProps(t,this.constructor.__notifyProps),n||this.ready()}setProperties(t){Object.entries(t).forEach(([n,r])=>{const o=this.constructor.__propKeys.get(n),a=this[o];this[o]=r,this.requestUpdate(n,a)}),this.hasUpdated&&this.performUpdate()}_createMethodObserver(t){const n=vt(this,"__dynamicMethodObservers"),{method:r,observerProps:o}=gt(t);n.set(r,o)}_createPropertyObserver(t,n){vt(this,"__dynamicPropertyObservers").set(n,t)}__runComplexObservers(t,n){n.forEach((r,o)=>{r.some(a=>t.has(a))&&(this[o]?this[o](...r.map(a=>this[a])):console.warn(`observer method ${o} not defined`))})}__runDynamicObservers(t,n){n.forEach((r,o)=>{t.has(r)&&this[o]&&this[o](this[r],t.get(r))})}__runObservers(t,n){t.forEach((r,o)=>{const a=n.get(o);a!==void 0&&this[a]&&this[a](this[o],r)})}__runNotifyProps(t,n){t.forEach((r,o)=>{n.has(o)&&this.dispatchEvent(new CustomEvent(`${ri(o)}-changed`,{detail:{value:this[o]}}))})}_get(t,n){return je(t,n)}_set(t,n,r){sn(t,n,r)}}return i},w=N(rn);/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 ...
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function on(s){const{baseStyles:i,themeStyles:e,elementStyles:t,lumoInjector:n}=s.constructor,r=s.__lumoStyleSheet;return r&&(i||e)?[...n.includeBaseStyles?i:[],r,...e]:[r,...t].filter(Boolean)}function Fi(s){Ds(s.shadowRoot,on(s))}function ai(s,i){s.__lumoStyleSheet=i,Fi(s)}function mt(s){s.__lumoStyleSheet=void 0,Fi(s)}/**
 * @license
 * Copyright (c) 2000 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const li=new Set;function Di(s){li.has(s)||(li.add(s),console.warn(s))}/**
 * @license
 * Copyright (c) 2000 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const di=new WeakMap;function hi(s){try{return s.media.mediaText}catch{return Di('[LumoInjector] Browser denied to access property "mediaText" for some CSS rules, so they were skipped.'),""}}function an(s){try{return s.cssRules}catch{return Di('[LumoInjector] Browser denied to access property "cssRules" for some CSS stylesheets, so they were skipped.'),[]}}function $i(s,i={tags:new Map,modules:new Map}){for(const e of an(s)){if(e instanceof CSSImportRule){const t=hi(e);t.startsWith("lumo_")?i.modules.set(t,[...e.styleSheet.cssRules]):$i(e.styleSheet,i);continue}if(e instanceof CSSMediaRule){const t=hi(e);t.startsWith("lumo_")&&i.modules.set(t,[...e.cssRules]);continue}if(e instanceof CSSStyleRule&&e.cssText.includes("-inject")){for(const t of e.style){const n=t.match(/^--_lumo-(.*)-inject-modules$/u)?.[1];if(!n)continue;const r=e.style.getPropertyValue(t);i.tags.set(n,r.split(",").map(o=>o.trim().replace(/'|"/gu,"")))}continue}}return i}function ln(s){let i=new Map,e=new Map;for(const t of s){let n=di.get(t);n||(n=$i(t),di.set(t,n)),i=new Map([...i,...n.tags]),e=new Map([...e,...n.modules])}return{tags:i,modules:e}}/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function Ni(s){return`--_lumo-${s.is}-inject`}class dn{#e;#i;#t=new Map;#s=new Map;constructor(i=document){this.#e=i,this.handlePropertyChange=this.handlePropertyChange.bind(this),this.#i=Dt.for(i),this.#i.addEventListener("property-changed",this.handlePropertyChange)}disconnect(){this.#i.removeEventListener("property-changed",this.handlePropertyChange),this.#t.clear(),this.#s.values().forEach(i=>i.forEach(mt))}forceUpdate(){for(const i of this.#t.keys())this.#n(i)}componentConnected(i){const{lumoInjector:e}=i.constructor,{is:t}=e;this.#s.set(t,this.#s.get(t)??new Set),this.#s.get(t).add(i);const n=this.#t.get(t);if(n){n.cssRules.length>0&&ai(i,n);return}this.#r(t);const r=Ni(e);this.#i.observe(r)}componentDisconnected(i){const{is:e}=i.constructor.lumoInjector;this.#s.get(e)?.delete(i),mt(i)}handlePropertyChange(i){const{propertyName:e}=i.detail,t=e.match(/^--_lumo-(.*)-inject$/u)?.[1];t&&this.#n(t)}#r(i){this.#t.set(i,new CSSStyleSheet),this.#n(i)}#n(i){const{tags:e,modules:t}=ln(this.#o),n=(e.get(i)??[]).flatMap(o=>t.get(o)??[]).map(o=>o.cssText).join(`
`),r=this.#t.get(i);r.replaceSync(n),this.#s.get(i)?.forEach(o=>{n?ai(o,r):mt(o)})}get#o(){let i=new Set;for(const e of[this.#e,document])i=i.union(new Set(e.styleSheets)),i=i.union(new Set(e.adoptedStyleSheets));return[...i]}}/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ci=new Set;function Bi(s){const i=s.getRootNode();return i.host&&i.host.constructor.version?Bi(i.host):i}const R=s=>class extends s{static finalize(){super.finalize();const e=Ni(this.lumoInjector);this.is&&!ci.has(e)&&(ci.add(e),CSS.registerProperty({name:e,syntax:"<number>",inherits:!0,initialValue:"0"}))}static get lumoInjector(){return{is:this.is,includeBaseStyles:!1}}connectedCallback(){super.connectedCallback();const e=Bi(this);e.__lumoInjectorDisabled||this.isConnected&&(e.__lumoInjector||=new dn(e),this.__lumoInjector=e.__lumoInjector,this.__lumoInjector.componentConnected(this))}disconnectedCallback(){super.disconnectedCallback(),this.__lumoInjector&&(this.__lumoInjector.componentDisconnected(this),this.__lumoInjector=void 0)}};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Pe=s=>class extends s{static get properties(){return{_theme:{type:String,readOnly:!0}}}static get observedAttributes(){return[...super.observedAttributes,"theme"]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e==="theme"&&this._set_theme(n)}};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Rt=[],hn=new Set,cn=new Set;function un(s){return s&&Object.prototype.hasOwnProperty.call(s,"__themes")}function _n(s,i){return(s||"").split(" ").some(e=>new RegExp(`^${e.split("*").join(".*")}$`,"u").test(i))}function pn(s){return s.map(i=>i.cssText).join(`
`)}const fn="vaadin-themable-mixin-style";function gn(s,i){const e=document.createElement("style");e.id=fn,e.textContent=pn(s),i.content.appendChild(e)}function vn(s=""){let i=0;return s.startsWith("lumo-")||s.startsWith("material-")?i=1:s.startsWith("vaadin-")&&(i=2),i}function Vi(s){const i=[];return s.include&&[].concat(s.include).forEach(e=>{const t=Rt.find(n=>n.moduleId===e);t?i.push(...Vi(t),...t.styles):console.warn(`Included moduleId ${e} not found in style registry`)},s.styles),i}function mn(s){const i=`${s}-default-theme`,e=Rt.filter(t=>t.moduleId!==i&&_n(t.themeFor,s)).map(t=>({...t,styles:[...Vi(t),...t.styles],includePriority:vn(t.moduleId)})).sort((t,n)=>n.includePriority-t.includePriority);return e.length>0?e:Rt.filter(t=>t.moduleId===i)}const A=s=>class extends Pe(s){constructor(){super(),hn.add(new WeakRef(this))}static finalize(){if(super.finalize(),this.is&&cn.add(this.is),this.elementStyles)return;const e=this.prototype._template;!e||un(this)||gn(this.getStylesForThis(),e)}static finalizeStyles(e){return this.baseStyles=e?[e].flat(1/0):[],this.themeStyles=this.getStylesForThis(),[...this.baseStyles,...this.themeStyles]}static getStylesForThis(){const e=s.__themes||[],t=Object.getPrototypeOf(this.prototype),n=(t?t.constructor.__themes:[])||[];this.__themes=[...e,...n,...mn(this.is)];const r=this.__themes.flatMap(o=>o.styles);return r.filter((o,a)=>a===r.lastIndexOf(o))}};/**
 * @license
 * Copyright (c) 2026 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const bn=(s,...i)=>{const e=document.createElement("style");e.id=s,e.textContent=i.map(t=>t.toString()).join(`
`),document.head.insertAdjacentElement("afterbegin",e)};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */["--vaadin-text-color","--vaadin-text-color-disabled","--vaadin-text-color-secondary","--vaadin-border-color","--vaadin-border-color-secondary","--vaadin-background-color"].forEach(s=>{CSS.registerProperty({name:s,syntax:"<color>",inherits:!0,initialValue:"light-dark(black, white)"})});bn("vaadin-base",m`
    @layer vaadin.base {
      html {
        /* Background color */
...
`,yn=window.Vaadin.featureFlags.layoutComponentImprovements,Cn=m`
 ...
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class wn extends A(P(w(R(x)))){static get is(){return"vaadin-vertical-layout"}static get styles(){return xn}static get lumoInjector(){return{...super.lumoInjector,includeBaseStyles:!0}}render(){return y`<slot></slot>`}}b(wn);/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const tt=m`
 ...
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const it=s=>s.test(navigator.userAgent),Ot=s=>s.test(navigator.platform),An=s=>s.test(navigator.vendor),zt=it(/Android/u),Hi=it(/Chrome/u)&&An(/Google Inc/u),qi=it(/Firefox/u),Tn=Ot(/^iPad/u)||Ot(/^Mac/u)&&navigator.maxTouchPoints>1,kn=Ot(/^iPhone/u),ve=kn||Tn,$t=it(/^((?!chrome|android).)*safari/iu),Me=(()=>{try{return document.createEvent("TouchEvent"),!0}catch{return!1}})();/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */let Nt=!1;window.addEventListener("keydown",()=>{Nt=!0},{capture:!0});window.addEventListener("mousedown",()=>{Nt=!1},{capture:!0});function Ge(){let s=document.activeElement||document.body;for(;s.shadowRoot&&s.shadowRoot.activeElement;)s=s.shadowRoot.activeElement;return s}function se(){return Nt}function Wi(s){const i=s.style;if(i.visibility==="hidden"||i.display==="none")return!0;const e=window.getComputedStyle(s);return e.visibility==="hidden"||e.display==="none"}function Rn(s,i){const e=Math.max(s.tabIndex,0),t=Math.max(i.tabIndex,0);return e===0||t===0?t>e:e>t}function On(s,i){const e=[];for(;s.length>0&&i.length>0;)Rn(s[0],i[0])?e.push(i.shift()):e.push(s.shift());return e.concat(s,i)}function Lt(s){const i=s.length;if(i<2)return s;const e=Math.ceil(i/2),t=Lt(s.slice(0,e)),n=Lt(s.slice(e));return On(t,n)}function ze(s){return s.checkVisibility?!s.checkVisibility({visibilityProperty:!0}):s.offsetParent===null&&s.clientWidth===0&&s.clientHeight===0?!0:Wi(s)}function Bt(s){return s.matches('[tabindex="-1"]')?!1:s.matches("input, select, textarea, button, object")?s.matches(":not([disabled])"):s.matches("a[href], area[href], iframe, [tabindex], [contentEditable]")}function Vt(s){return s.getRootNode().activeElement===s}function zn(s){if(!Bt(s))return-1;const i=s.getAttribute("tabindex")||0;return Number(i)}function Ui(s,i){if(s.nodeType!==Node.ELEMENT_NODE||Wi(s))return!1;const e=s,t=zn(e);let n=t>0;t>=0&&i.push(e);let r=[];return e.localName==="slot"?r=e.assignedNodes({flatten:!0}):r=(e.shadowRoot||e).children,[...r].forEach(o=>{n=Ui(o,i)||n}),n}function Ln(s){const i=[];return Ui(s,i)?Lt(i):i}/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Pn{saveFocus(i){this.focusNode=i||Ge()}restoreFocus(i){const e=this.focusNode;if(!e)return;const t={preventScroll:i?i.preventScroll:!1,focusVisible:i?i.focusVisible:!1};Ge()===document.body?setTimeout(()=>e.focus(t)):e.focus(t),this.focusNode=null}}/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const bt=[];class Mn{constructor(i){this.host=i,this.__trapNode=null,this.__onKeyDown=this.__onKeyDown.bind(this)}get __focusableElements(){return Ln(this.__trapNode)}get __focusedElementIndex(){const i=this.__focusableElements;return i.indexOf(i.filter(Vt).pop())}hostConnected(){document.addEventListener("keydown",this.__onKeyDown)}hostDisconnected(){document.removeEventListener("keydown",this.__onKeyDown)}trapFocus(i){if(this.__trapNode=i,this.__focusableElements.length===0)throw this.__trapNode=null,new Error("The trap node should have at least one focusable descendant or be focusable itself.");bt.push(this),this.__focusedElementIndex===-1&&this.__focusableElements[0].focus({focusVisible:se()})}releaseFocus(){this.__trapNode=null,bt.pop()}__onKeyDown(i){if(this.__trapNode&&this===Array.from(bt).pop()&&i.key==="Tab"){i.preventDefault();const e=i.shiftKey;this.__focusNextElement(e)}}__focusNextElement(i=!1){const e=this.__focusableElements,t=i?-1:1,n=this.__focusedElementIndex,r=(e.length+n+t)%e.length,o=e[r];o.focus({focusVisible:!0}),o.localName==="input"&&o.select()}}/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ji=s=>class extends s{static get properties(){return{focusTrap:{type:Boolean,value:!1},restoreFocusOnClose:{type:Boolean,value:!1},restoreFocusNode:{type:HTMLElement}}}constructor(){super(),this.__focusTrapController=new Mn(this),this.__focusRestorationController=new Pn}get _contentRoot(){return this}ready(){super.ready(),this.addController(this.__focusTrapController),this.addController(this.__focusRestorationController)}get _focusTrapRoot(){return this.$.overlay}_resetFocus(){if(this.focusTrap&&this.__focusTrapController.releaseFocus(),this.restoreFocusOnClose&&this._shouldRestoreFocus()){const e=se(),t=!e;this.__focusRestorationController.restoreFocus({preventScroll:t,focusVisible:e})}}_saveFocus(){this.restoreFocusOnClose&&this.__focusRestorationController.saveFocus(this.restoreFocusNode)}_trapFocus(){this.focusTrap&&!ze(this._focusTrapRoot)&&this.__focusTrapController.trapFocus(this._focusTrapRoot)}_shouldRestoreFocus(){const e=Ge();return e===document.body||this._deepContains(e)}_deepContains(e){if(this._contentRoot.contains(e))return!0;let t=e;const n=e.ownerDocument;for(;t&&t!==n&&t!==this._contentRoot;)t=t.parentNode||t.host;return t===this._contentRoot}};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const We=new Set,Ke=()=>[...We].filter(s=>!s.hasAttribute("closing")),Gi=s=>{const i=Ke(),e=i[i.indexOf(s)+1];return e?s._deepContains(e)?Gi(e):!1:!0},_i=(s,i=e=>!0)=>{const e=Ke().filter(i);return s===e.pop()},Fn=s=>class extends s{get _last(){return _i(this)}get _isAttached(){return We.has(this)}bringToFront(){_i(this)||Gi(this)||(this.matches(":popover-open")&&(this.hidePopover(),this.showPopover()),this._removeAttachedInstance(),this._appendAttachedInstance())}_enterModalState(){document.body.style.pointerEvents!=="none"&&(this._previousDocumentPointerEvents=document.body.style.pointerEvents,document.body.style.pointerEvents="none"),Ke().forEach(e=>{e!==this&&(e.$.overlay.style.pointerEvents="none")})}_exitModalState(){this._previousDocumentPointerEvents!==void 0&&(document.body.style.pointerEvents=this._previousDocumentPointerEvents,delete this._previousDocumentPointerEvents);const e=Ke();let t;for(;(t=e.pop())&&!(t!==this&&(t.$.overlay.style.removeProperty("pointer-events"),!t.modeless)););}_appendAttachedInstance(){We.add(this)}_removeAttachedInstance(){this._isAttached&&We.delete(this)}};/**
 * @license
 * Copyright (c) 2024 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function Dn(s,i){let e=null,t;const n=document.documentElement;function r(){t&&clearTimeout(t),e&&e.disconnect(),e=null}function o(a=!1,l=1){r();const{left:h,top:_,width:f,height:g}=s.getBoundingClientRect();if(a||i(),!f||!g)return;const E=Math.floor(_),z=Math.floor(n.clientWidth-(h+f)),O=Math.floor(n.clientHeight-(_+g)),M=Math.floor(h),d={rootMargin:`${-E}px ${-z}px ${-O}px ${-M}px`,threshold:Math.max(0,Math.min(1,l))||1};let c=!0;function u(p){const v=p[0].intersectionRatio;if(v!==l){if(!c)return o();v?o(!1,v):t=setTimeout(()=>{o(!1,1e-7)},1e3)}c=!1}e=new IntersectionObserver(u,d),e.observe(s)}return o(!0),r}function L(s,i,e){const t=[s];s.owner&&t.push(s.owner),typeof e=="string"?t.forEach(n=>{n.setAttribute(i,e)}):e?t.forEach(n=>{n.setAttribute(i,"")}):t.forEach(n=>{n.removeAttribute(i)})}/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const st=s=>class extends ji(Fn(s)){static get properties(){return{opened:{type:Boolean,notify:!0,observer:"_openedChanged",reflectToAttribute:!0,sync:!0},owner:{type:Object,sync:!0},model:{type:Object,sync:!0},renderer:{type:Object,sync:!0},modeless:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_modelessChanged",sync:!0},hidden:{type:Boolean,reflectToAttribute:!0,observer:"_hiddenChanged",sync:!0},withBackdrop:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_withBackdropChanged",sync:!0}}}static get observers(){return["_rendererOrDataChanged(renderer, owner, model, opened)"]}get _rendererRoot(){return this}constructor(){super(),this._boundMouseDownListener=this._mouseDownListener.bind(this),this._boundMouseUpListener=this._mouseUpListener.bind(this),this._boundOutsideClickListener=this._outsideClickListener.bind(this),this._boundKeydownListener=this._keydownListener.bind(this),ve&&(this._boundIosResizeListener=()=>this._detectIosNavbar())}firstUpdated(){super.firstUpdated(),this.popover="manual",this.addEventListener("click",()=>{}),this.$.backdrop&&this.$.backdrop.addEventListener("click",()=>{}),this.addEventListener("mouseup",()=>{document.activeElement===document.body&&this.$.overlay.getAttribute("tabindex")==="0"&&this.$.overlay.focus()}),this.addEventListener("animationcancel",()=>{this._flushAnimation("opening"),this._flushAnimation("closing")})}connectedCallback(){super.connectedCallback(),this._boundIosResizeListener&&(this._detectIosNavbar(),window.addEventListener("resize",this._boundIosResizeListener))}disconnectedCallback(){super.disconnectedCallback(),this.__scheduledOpen&&(cancelAnimationFrame(this.__scheduledOpen),this.__scheduledOpen=null),this._boundIosResizeListener&&window.removeEventListener("resize",this._boundIosResizeListener)}requestContentUpdate(){this.renderer&&this.renderer.call(this.owner,this._rendererRoot,this.owner,this.model)}close(e){const t=new CustomEvent("vaadin-overlay-close",{bubbles:!0,cancelable:!0,detail:{overlay:this,sourceEvent:e}});this.dispatchEvent(t),document.body.dispatchEvent(t),t.defaultPrevented||(this.opened=!1)}setBounds(e,t=!0){const n=this.$.overlay,r={...e};t&&n.style.position!=="absolute"&&(n.style.position="absolute"),Object.keys(r).forEach(o=>{r[o]!==null&&!isNaN(r[o])&&(r[o]=`${r[o]}px`)}),Object.assign(n.style,r)}_detectIosNavbar(){if(!this.opened)return;const e=window.innerHeight,n=window.innerWidth>e,r=document.documentElement.clientHeight;n&&r>e?this.style.setProperty("--vaadin-overlay-viewport-bottom",`${r-e}px`):this.style.setProperty("--vaadin-overlay-viewport-bottom","0")}_shouldAddGlobalListeners(){return!this.modeless}_addGlobalListeners(){this.__hasGlobalListeners||(this.__hasGlobalListeners=!0,document.addEventListener("mousedown",this._boundMouseDownListener),document.addEventListener("mouseup",this._boundMouseUpListener),document.documentElement.addEventListener("click",this._boundOutsideClickListener,!0))}_removeGlobalListeners(){this.__hasGlobalListeners&&(this.__hasGlobalListeners=!1,document.removeEventListener("mousedown",this._boundMouseDownListener),document.removeEventListener("mouseup",this._boundMouseUpListener),document.documentElement.removeEventListener("click",this._boundOutsideClickListener,!0))}_rendererOrDataChanged(e,t,n,r){const o=this._oldOwner!==t||this._oldModel!==n;this._oldModel=n,this._oldOwner=t;const a=this._oldRenderer!==e,l=this._oldRenderer!==void 0;this._oldRenderer=e;const h=this._oldOpened!==r;this._oldOpened=r,a&&l&&(this._rendererRoot.innerHTML="",delete this._rendererRoot._$litPart$),r&&e&&(a||h||o)&&this.requestContentUpdate()}_modelessChanged(e){this.opened&&(this._shouldAddGlobalListeners()?this._addGlobalListeners():this._removeGlobalListeners()),e?this._exitModalState():this.opened&&this._enterModalState(),L(this,"modeless",e)}_withBackdropChanged(e){L(this,"with-backdrop",e)}_openedChanged(e,t){if(e){if(!this.isConnected){this.opened=!1;return}this._saveFocus(),this._animatedOpening(),this.__scheduledOpen=requestAnimationFrame(()=>{setTimeout(()=>{this._trapFocus();const n=new CustomEvent("vaadin-overlay-open",{detail:{overlay:this},bubbles:!0});this.dispatchEvent(n),document.body.dispatchEvent(n)})}),document.addEventListener("keydown",this._boundKeydownListener),this._shouldAddGlobalListeners()&&this._addGlobalListeners()}else t&&(this.__scheduledOpen&&(cancelAnimationFrame(this.__scheduledOpen),this.__scheduledOpen=null),this._resetFocus(),this._animatedClosing(),document.removeEventListener("keydown",this._boundKeydownListener),this._shouldAddGlobalListeners()&&this._removeGlobalListeners())}_hiddenChanged(e){e&&this.hasAttribute("closing")&&this._flushAnimation("closing")}_shouldAnimate(){const e=getComputedStyle(this),t=e.getPropertyValue("animation-name");return!(e.getPropertyValue("display")==="none")&&t&&t!=="none"}_enqueueAnimation(e,t){const n=`__${e}Handler`,r=o=>{o&&o.target!==this||(t(),this.removeEventListener("animationend",r),delete this[n])};this[n]=r,this.addEventListener("animationend",r)}_flushAnimation(e){const t=`__${e}Handler`;typeof this[t]=="function"&&this[t]()}_animatedOpening(){this._isAttached&&this.hasAttribute("closing")&&this._flushAnimation("closing"),this._attachOverlay(),this._appendAttachedInstance(),this.bringToFront(),this.modeless||this._enterModalState(),L(this,"opening",!0),this._shouldAnimate()?this._enqueueAnimation("opening",()=>{this._finishOpening()}):this._finishOpening()}_attachOverlay(){this.showPopover()}_finishOpening(){L(this,"opening",!1)}_finishClosing(){this._detachOverlay(),this._removeAttachedInstance(),this.$.overlay.style.removeProperty("pointer-events"),L(this,"closing",!1),this.dispatchEvent(new CustomEvent("vaadin-overlay-closed"))}_animatedClosing(){this.hasAttribute("opening")&&this._flushAnimation("opening"),this._isAttached&&(this._exitModalState(),L(this,"closing",!0),this.dispatchEvent(new CustomEvent("vaadin-overlay-closing")),this._shouldAnimate()?this._enqueueAnimation("closing",()=>{this._finishClosing()}):this._finishClosing())}_detachOverlay(){this.hidePopover()}_mouseDownListener(e){this._mouseDownInside=e.composedPath().indexOf(this.$.overlay)>=0}_mouseUpListener(e){this._mouseUpInside=e.composedPath().indexOf(this.$.overlay)>=0}_shouldCloseOnOutsideClick(e){return this._last}_outsideClickListener(e){if(e.composedPath().includes(this.$.overlay)||this._mouseDownInside||this._mouseUpInside){this._mouseDownInside=!1,this._mouseUpInside=!1;return}if(!this._shouldCloseOnOutsideClick(e))return;const t=new CustomEvent("vaadin-overlay-outside-click",{cancelable:!0,detail:{sourceEvent:e}});this.dispatchEvent(t),this.opened&&!t.defaultPrevented&&this.close(e)}_keydownListener(e){if(!(!this._last||e.defaultPrevented)&&!(!this._shouldAddGlobalListeners()&&!e.composedPath().includes(this._focusTrapRoot))&&e.key==="Escape"){const t=new CustomEvent("vaadin-overlay-escape-press",{cancelable:!0,detail:{sourceEvent:e}});this.dispatchEvent(t),this.opened&&!t.defaultPrevented&&this.close(e)}}};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const $n=s=>class extends st(s){static get properties(){return{headerTitle:{type:String},headerRenderer:{type:Object},footerRenderer:{type:Object}}}static get observers(){return["_headerFooterRendererChange(headerRenderer, footerRenderer, opened)","_headerTitleChanged(headerTitle, opened)"]}get _contentRoot(){return this.owner}get _rendererRoot(){if(!this.__savedRoot){const e=document.createElement("vaadin-dialog-content");e.style.display="contents",this.owner.appendChild(e),this.__savedRoot=e}return this.__savedRoot}ready(){super.ready(),this.__resizeObserver=new ResizeObserver(()=>{requestAnimationFrame(()=>{this.__updateOverflow()})}),this.__resizeObserver.observe(this.$.resizerContainer),this.$.content.addEventListener("scroll",()=>{this.__updateOverflow()}),this.shadowRoot.addEventListener("slotchange",()=>{this.__updateOverflow()})}__createContainer(e){const t=document.createElement("vaadin-dialog-content");return t.setAttribute("slot",e),t}__clearContainer(e){e.innerHTML="",delete e._$litPart$}__initContainer(e,t){return e?this.__clearContainer(e):(e=this.__createContainer(t),this.owner.appendChild(e)),e}_headerFooterRendererChange(e,t,n){const r=this.__oldHeaderRenderer!==e;this.__oldHeaderRenderer=e;const o=this.__oldFooterRenderer!==t;this.__oldFooterRenderer=t;const a=this._oldOpenedFooterHeader!==n;this._oldOpenedFooterHeader=n,L(this,"has-header",!!e),L(this,"has-footer",!!t),r&&(e?this.headerContainer=this.__initContainer(this.headerContainer,"header-content"):this.headerContainer&&(this.headerContainer.remove(),this.headerContainer=null,this.__updateOverflow())),o&&(t?this.footerContainer=this.__initContainer(this.footerContainer,"footer"):this.footerContainer&&(this.footerContainer.remove(),this.footerContainer=null,this.__updateOverflow())),(e&&(r||a)||t&&(o||a))&&n&&this.requestContentUpdate()}_headerTitleChanged(e,t){L(this,"has-title",!!e),t&&(e||this._oldHeaderTitle)&&this.requestContentUpdate(),this._oldHeaderTitle=e}_headerTitleRenderer(){this.headerTitle?(this.headerTitleElement||(this.headerTitleElement=document.createElement("h2"),this.headerTitleElement.setAttribute("slot","title"),this.headerTitleElement.classList.add("draggable")),this.owner.appendChild(this.headerTitleElement),this.headerTitleElement.textContent=this.headerTitle):this.headerTitleElement&&(this.headerTitleElement.remove(),this.headerTitleElement=null)}requestContentUpdate(){super.requestContentUpdate(),this.headerContainer&&this.headerRenderer&&this.headerRenderer.call(this.owner,this.headerContainer,this.owner),this.footerContainer&&this.footerRenderer&&this.footerRenderer.call(this.owner,this.footerContainer,this.owner),this._headerTitleRenderer(),this.__updateOverflow()}getBounds(){const e=this.$.overlay.getBoundingClientRect(),t=this.getBoundingClientRect(),n=e.top-t.top,r=e.left-t.left,o=e.width,a=e.height;return{top:n,left:r,width:o,height:a}}__updateOverflow(){let e="";const t=this.$.content;t.scrollTop>0&&(e+=" top"),t.scrollTop<t.scrollHeight-t.clientHeight&&(e+=" bottom");const n=e.trim();n.length>0&&this.getAttribute("overflow")!==n?L(this,"overflow",n):n.length===0&&this.hasAttribute("overflow")&&L(this,"overflow",null)}};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Nn extends $n($(A(w(R(x))))){static get is(){return"vaadin-dialog-overlay"}static get styles(){return In}get _focusTrapRoot(){return this.owner}render(){return y`
 ...
 */class Un extends Wn(Vn(qn(Hn(Bn(Pe(P(w(x)))))))){static get is(){return"vaadin-dialog"}static get styles(){return m`
    ...
    `}updated(i){super.updated(i),i.has("headerTitle")&&(this.ariaLabel=this.headerTitle)}}b(Un);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jn=(s,i)=>s?._$litType$!==void 0,Yi=s=>s.strings===void 0,Gn={},Kn=(s,i=Gn)=>s._$AH=i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Re=(s,i)=>{const e=s._$AN;if(e===void 0)return!1;for(const t of e)t._$AO?.(i,!1),Re(t,i);return!0},Xe=s=>{let i,e;do{if((i=s._$AM)===void 0)break;e=i._$AN,e.delete(s),s=i}while(e?.size===0)},Xi=s=>{for(let i;i=s._$AM;s=i){let e=i._$AN;if(e===void 0)i._$AN=e=new Set;else if(e.has(s))break;e.add(s),Zn(i)}};function Yn(s){this._$AN!==void 0?(Xe(this),this._$AM=s,Xi(this)):this._$AM=s}function Xn(s,i=!1,e=0){const t=this._$AH,n=this._$AN;if(n!==void 0&&n.size!==0)if(i)if(Array.isArray(t))for(let r=e;r<t.length;r++)Re(t[r],!1),Xe(t[r]);else t!=null&&(Re(t,!1),Xe(t));else Re(this,s)}const Zn=s=>{s.type==J.CHILD&&(s._$AP??=Xn,s._$AQ??=Yn)};class Qn extends ki{constructor(){super(...arguments),this._$AN=void 0}_$AT(i,e,t){super._$AT(i,e,t),Xi(this),this.isConnected=i._$AU}_$AO(i,e=!0){i!==this.isConnected&&(this.isConnected=i,i?this.reconnected?.():this.disconnected?.()),e&&(Re(this,i),Xe(this))}setValue(i){if(Yi(this._$Ct))this._$Ct._$AI(i,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=i,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}class Jn extends Qn{constructor(i){if(super(i),i.type!==J.CHILD)throw new Error(`${this.constructor.directiveName}() can only be used in child bindings`)}update(i,[e,t]){return this.updateContent(i,e,t),Te}updateContent(i,e,t){const{parentNode:n,startNode:r}=i;this.__parentNode=n;const o=t!=null,a=o?this.getNewNode(e,t):null,l=this.getOldNode(i);if(clearTimeout(this.__parentNode.__nodeRetryTimeout),o&&!a)this.__parentNode.__nodeRetryTimeout=setTimeout(()=>this.updateContent(i,e,t));else{if(l===a)return;l&&a?n.replaceChild(a,l):l?n.removeChild(l):a&&r.after(a)}}getNewNode(i,e){return window.Vaadin.Flow.clients[i].getByNodeId(e)}getOldNode(i){const{startNode:e,endNode:t}=i;if(e.nextSibling!==t)return e.nextSibling}disconnected(){clearTimeout(this.__parentNode.__nodeRetryTimeout)}}const Zi=Ri(Jn);function er(s,i){return Zi(s,i)}function tr(s,i,e){Ft(y`${i.map(t=>Zi(s,t))}`,e)}function ir(s){const i=s.insertBefore;s.insertBefore=function(e,t){return t&&t.parentNode===this?i.call(this,e,t):i.call(this,e,null)}}window.Vaadin||={};window.Vaadin.FlowComponentHost||={patchVirtualContainer:ir,getNode:er,setChildNodes:tr};/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const sr=m`
 ...
 */class Yt extends br(A(P(w(R(x))))){static get is(){return"vaadin-text-field"}static get styles(){return[ot]}render(){return y`
    ...
    `}ready(){super.ready(),this._tooltipController=new Z(this),this._tooltipController.setPosition("top"),this._tooltipController.setAriaTarget(this.inputElement),this.addController(this._tooltipController)}_renderSuffix(){return y`
 ...
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const xt={start:"top",end:"bottom"},wt={start:"left",end:"right"},pi=new ResizeObserver(s=>{setTimeout(()=>{s.forEach(i=>{i.target.__overlay&&i.target.__overlay._updatePosition()})})}),Xt=s=>class extends s{static get properties(){return{positionTarget:{type:Object,value:null,sync:!0},horizontalAlign:{type:String,value:"start",sync:!0},verticalAlign:{type:String,value:"top",sync:!0},noHorizontalOverlap:{type:Boolean,value:!1,sync:!0},noVerticalOverlap:{type:Boolean,value:!1,sync:!0},requiredVerticalSpace:{type:Number,value:0,sync:!0}}}constructor(){super(),this.__onScroll=this.__onScroll.bind(this),this._updatePosition=this._updatePosition.bind(this)}connectedCallback(){super.connectedCallback(),this.opened&&this.__addUpdatePositionEventListeners()}disconnectedCallback(){super.disconnectedCallback(),this.__removeUpdatePositionEventListeners()}updated(e){if(super.updated(e),e.has("positionTarget")){const n=e.get("positionTarget");(!this.positionTarget&&n||this.positionTarget&&!n&&this.__margins)&&this.__resetPosition()}(e.has("opened")||e.has("positionTarget"))&&this.__updatePositionSettings(this.opened,this.positionTarget),["horizontalAlign","verticalAlign","noHorizontalOverlap","noVerticalOverlap","requiredVerticalSpace"].some(n=>e.has(n))&&this._updatePosition()}__addUpdatePositionEventListeners(){window.visualViewport.addEventListener("resize",this._updatePosition),window.visualViewport.addEventListener("scroll",this.__onScroll,!0),this.__positionTargetAncestorRootNodes=rr(this.positionTarget),this.__positionTargetAncestorRootNodes.forEach(e=>{e.addEventListener("scroll",this.__onScroll,!0)}),this.positionTarget&&(this.__observePositionTargetMove=Dn(this.positionTarget,()=>{this._updatePosition()}))}__removeUpdatePositionEventListeners(){window.visualViewport.removeEventListener("resize",this._updatePosition),window.visualViewport.removeEventListener("scroll",this.__onScroll,!0),this.__positionTargetAncestorRootNodes&&(this.__positionTargetAncestorRootNodes.forEach(e=>{e.removeEventListener("scroll",this.__onScroll,!0)}),this.__positionTargetAncestorRootNodes=null),this.__observePositionTargetMove&&(this.__observePositionTargetMove(),this.__observePositionTargetMove=null)}__updatePositionSettings(e,t){if(this.__removeUpdatePositionEventListeners(),t&&(t.__overlay=null,pi.unobserve(t),e&&(this.__addUpdatePositionEventListeners(),t.__overlay=this,pi.observe(t))),e){const n=getComputedStyle(this);this.__margins||(this.__margins={},["top","bottom","left","right"].forEach(r=>{this.__margins[r]=parseInt(n[r],10)})),this._updatePosition(),requestAnimationFrame(()=>this._updatePosition())}}__onScroll(e){e.target instanceof Node&&this._deepContains(e.target)||this._updatePosition()}__resetPosition(){this.__margins=null,Object.assign(this.style,{justifyContent:"",alignItems:"",top:"",bottom:"",left:"",right:""}),L(this,"bottom-aligned",!1),L(this,"top-aligned",!1),L(this,"end-aligned",!1),L(this,"start-aligned",!1)}_updatePosition(){if(!this.positionTarget||!this.opened||!this.__margins)return;const e=this.positionTarget.getBoundingClientRect();if(e.width===0&&e.height===0&&this.opened){this.opened=!1;return}const t=this.__shouldAlignStartVertically(e);this.style.justifyContent=t?"flex-start":"flex-end";const n=this.__isRTL,r=this.__shouldAlignStartHorizontally(e,n),o=!n&&r||n&&!r;this.style.alignItems=o?"flex-start":"flex-end";const a=this.getBoundingClientRect(),l=this.__calculatePositionInOneDimension(e,a,this.noVerticalOverlap,xt,this,t),h=this.__calculatePositionInOneDimension(e,a,this.noHorizontalOverlap,wt,this,r);Object.assign(this.style,l,h),L(this,"bottom-aligned",!t),L(this,"top-aligned",t),L(this,"end-aligned",!o),L(this,"start-aligned",o)}__shouldAlignStartHorizontally(e,t){const n=Math.max(this.__oldContentWidth||0,this.$.overlay.offsetWidth);this.__oldContentWidth=this.$.overlay.offsetWidth;const r=Math.min(window.innerWidth,document.documentElement.clientWidth),o=!t&&this.horizontalAlign==="start"||t&&this.horizontalAlign==="end";return this.__shouldAlignStart(e,n,r,this.__margins,o,this.noHorizontalOverlap,wt)}__shouldAlignStartVertically(e){const t=this.requiredVerticalSpace||Math.max(this.__oldContentHeight||0,this.$.overlay.offsetHeight);this.__oldContentHeight=this.$.overlay.offsetHeight;const n=Math.min(window.innerHeight,document.documentElement.clientHeight),r=this.verticalAlign==="top";return this.__shouldAlignStart(e,t,n,this.__margins,r,this.noVerticalOverlap,xt)}__shouldAlignStart(e,t,n,r,o,a,l){const h=n-e[a?l.end:l.start]-r[l.end],_=e[a?l.start:l.end]-r[l.start],f=o?h:_,E=f>(o?_:h)||f>t;return o===E}__adjustBottomProperty(e,t,n){let r;if(e===t.end){if(t.end===xt.end){const o=Math.min(window.innerHeight,document.documentElement.clientHeight);if(n>o&&this.__oldViewportHeight){const a=this.__oldViewportHeight-o;r=n-a}this.__oldViewportHeight=o}if(t.end===wt.end){const o=Math.min(window.innerWidth,document.documentElement.clientWidth);if(n>o&&this.__oldViewportWidth){const a=this.__oldViewportWidth-o;r=n-a}this.__oldViewportWidth=o}}return r}__calculatePositionInOneDimension(e,t,n,r,o,a){const l=a?r.start:r.end,h=a?r.end:r.start,_=parseFloat(o.style[l]||getComputedStyle(o)[l]),f=this.__adjustBottomProperty(l,r,_),g=t[a?r.start:r.end]-e[n===a?r.end:r.start],E=f?`${f}px`:`${_+g*(a?-1:1)}px`;return{[l]:E,[h]:""}}};/**
 * @license
 * Copyright (c) 2022 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const yr=s=>class extends Xt(st(s)){static get properties(){return{position:{type:String,reflectToAttribute:!0}}}_updatePosition(){if(super._updatePosition(),!this.positionTarget||!this.opened)return;this.removeAttribute("arrow-centered");const e=this.positionTarget.getBoundingClientRect(),t=this.$.overlay.getBoundingClientRect(),n=Math.min(window.innerWidth,document.documentElement.clientWidth);let r=!1;if(t.left<0?(this.style.left="0px",this.style.right="",r=!0):t.right>n&&(this.style.right="0px",this.style.left="",r=!0),!r&&(this.position==="bottom"||this.position==="top")){const o=e.width/2-t.width/2;if(this.style.left){const a=t.left+o;a>0&&(this.style.left=`${a}px`,this.setAttribute("arrow-centered",""))}if(this.style.right){const a=parseFloat(this.style.right)+o;a>0&&(this.style.right=`${a}px`,this.setAttribute("arrow-centered",""))}}if(this.position==="start"||this.position==="end"){const o=e.height/2-t.height/2;this.style.top=`${t.top+o}px`}}};/**
 * @license
 * Copyright (c) 2022 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Cr=m`
 ...
 * Copyright (c) 2022 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class xr extends yr($(A(w(R(x))))){static get is(){return"vaadin-tooltip-overlay"}static get styles(){return[tt,Cr]}render(){return y`
      <div part="overlay" id="overlay">
        <div part="content" id="content"><slot></slot></div>
      </div>
    `}}b(xr);/**
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Tr=s=>s,ds=typeof document.head.style.touchAction=="string",Ze="__polymerGestures",Et="__polymerGesturesHandled",Pt="__polymerGesturesTouchAction",fi=25,gi=5,kr=2,Rr=["mousedown","mousemove","mouseup","click"],Or=[0,1,4,2],zr=(function(){try{return new MouseEvent("test",{buttons:1}).buttons===1}catch{return!1}})();function Zt(s){return Rr.indexOf(s)>-1}let Lr=!1;(function(){try{const s=Object.defineProperty({},"passive",{get(){Lr=!0}});window.addEventListener("test",null,s),window.removeEventListener("test",null,s)}catch{}})();function hs(s){Zt(s)}const Pr=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/u),Mr={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function ae(s){const i=s.type;if(!Zt(i))return!1;if(i==="mousemove"){let t=s.buttons===void 0?1:s.buttons;return s instanceof window.MouseEvent&&!zr&&(t=Or[s.which]||0),!!(t&1)}return(s.button===void 0?0:s.button)===0}function Fr(s){if(s.type==="click"){if(s.detail===0)return!0;const i=te(s);if(!i.nodeType||i.nodeType!==Node.ELEMENT_NODE)return!0;const e=i.getBoundingClientRect(),t=s.pageX,n=s.pageY;return!(t>=e.left&&t<=e.right&&n>=e.top&&n<=e.bottom)}return!1}const K={touch:{x:0,y:0,id:-1,scrollDecided:!1}};function Dr(s){let i="auto";const e=us(s);for(let t=0,n;t<e.length;t++)if(n=e[t],n[Pt]){i=n[Pt];break}return i}function cs(s,i,e){s.movefn=i,s.upfn=e,document.addEventListener("mousemove",i),document.addEventListener("mouseup",e)}function ge(s){document.removeEventListener("mousemove",s.movefn),document.removeEventListener("mouseup",s.upfn),s.movefn=null,s.upfn=null}const us=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:s=>s.composedPath&&s.composedPath()||[],X={},oe=[];function _s(s,i){let e=document.elementFromPoint(s,i),t=e;for(;t&&t.shadowRoot&&!window.ShadyDOM;){const n=t;if(t=t.shadowRoot.elementFromPoint(s,i),n===t)break;t&&(e=t)}return e}function te(s){const i=us(s);return i.length>0?i[0]:s.target}function ps(s){const i=s.type,t=s.currentTarget[Ze];if(!t)return;const n=t[i];if(!n)return;if(!s[Et]&&(s[Et]={},i.startsWith("touch"))){const o=s.changedTouches[0];if(i==="touchstart"&&s.touches.length===1&&(K.touch.id=o.identifier),K.touch.id!==o.identifier)return;ds||(i==="touchstart"||i==="touchmove")&&$r(s)}const r=s[Et];if(!r.skip){for(let o=0,a;o<oe.length;o++)a=oe[o],n[a.name]&&!r[a.name]&&a.flow&&a.flow.start.indexOf(s.type)>-1&&a.reset&&a.reset();for(let o=0,a;o<oe.length;o++)a=oe[o],n[a.name]&&!r[a.name]&&(r[a.name]=!0,a[i](s))}}function $r(s){const i=s.changedTouches[0],e=s.type;if(e==="touchstart")K.touch.x=i.clientX,K.touch.y=i.clientY,K.touch.scrollDecided=!1;else if(e==="touchmove"){if(K.touch.scrollDecided)return;K.touch.scrollDecided=!0;const t=Dr(s);let n=!1;const r=Math.abs(K.touch.x-i.clientX),o=Math.abs(K.touch.y-i.clientY);s.cancelable&&(t==="none"?n=!0:t==="pan-x"?n=o>r:t==="pan-y"&&(n=r>o)),n?s.preventDefault():me("track")}}function le(s,i,e){return X[i]?(Nr(s,i,e),!0):!1}function fs(s,i,e){return X[i]?(Br(s,i,e),!0):!1}function Nr(s,i,e){const t=X[i],n=t.deps,r=t.name;let o=s[Ze];o||(s[Ze]=o={});for(let a=0,l,h;a<n.length;a++)l=n[a],!(Pr&&Zt(l)&&l!=="click")&&(h=o[l],h||(o[l]=h={_count:0}),h._count===0&&s.addEventListener(l,ps,hs(l)),h[r]=(h[r]||0)+1,h._count=(h._count||0)+1);s.addEventListener(i,e),t.touchAction&&Hr(s,t.touchAction)}function Br(s,i,e){const t=X[i],n=t.deps,r=t.name,o=s[Ze];if(o)for(let a=0,l,h;a<n.length;a++)l=n[a],h=o[l],h&&h[r]&&(h[r]=(h[r]||1)-1,h._count=(h._count||1)-1,h._count===0&&s.removeEventListener(l,ps,hs(l)));s.removeEventListener(i,e)}function ct(s){oe.push(s),s.emits.forEach(i=>{X[i]=s})}function Vr(s){for(let i=0,e;i<oe.length;i++){e=oe[i];for(let t=0,n;t<e.emits.length;t++)if(n=e.emits[t],n===s)return e}return null}function Hr(s,i){ds&&s instanceof HTMLElement&&q.run(()=>{s.style.touchAction=i}),s[Pt]=i}function Qt(s,i,e){const t=new Event(i,{bubbles:!0,cancelable:!0,composed:!0});if(t.detail=e,Tr(s).dispatchEvent(t),t.defaultPrevented){const n=e.preventer||e.sourceEvent;n&&n.preventDefault&&n.preventDefault()}}function me(s){const i=Vr(s);i.info&&(i.info.prevent=!0)}ct({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset(){ge(this.info)},mousedown(s){if(!ae(s))return;const i=te(s),e=this,t=r=>{ae(r)||(Ie("up",i,r),ge(e.info))},n=r=>{ae(r)&&Ie("up",i,r),ge(e.info)};cs(this.info,t,n),Ie("down",i,s)},touchstart(s){Ie("down",te(s),s.changedTouches[0],s)},touchend(s){Ie("up",te(s),s.changedTouches[0],s)}});function Ie(s,i,e,t){i&&Qt(i,s,{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:t,prevent(n){return me(n)}})}ct({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove(s){this.moves.length>kr&&this.moves.shift(),this.moves.push(s)},movefn:null,upfn:null,prevent:!1},reset(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,ge(this.info)},mousedown(s){if(!ae(s))return;const i=te(s),e=this,t=r=>{const o=r.clientX,a=r.clientY;vi(e.info,o,a)&&(e.info.state=e.info.started?r.type==="mouseup"?"end":"track":"start",e.info.state==="start"&&me("tap"),e.info.addMove({x:o,y:a}),ae(r)||(e.info.state="end",ge(e.info)),i&&St(e.info,i,r),e.info.started=!0)},n=r=>{e.info.started&&t(r),ge(e.info)};cs(this.info,t,n),this.info.x=s.clientX,this.info.y=s.clientY},touchstart(s){const i=s.changedTouches[0];this.info.x=i.clientX,this.info.y=i.clientY},touchmove(s){const i=te(s),e=s.changedTouches[0],t=e.clientX,n=e.clientY;vi(this.info,t,n)&&(this.info.state==="start"&&me("tap"),this.info.addMove({x:t,y:n}),St(this.info,i,e),this.info.state="track",this.info.started=!0)},touchend(s){const i=te(s),e=s.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:e.clientX,y:e.clientY}),St(this.info,i,e))}});function vi(s,i,e){if(s.prevent)return!1;if(s.started)return!0;const t=Math.abs(s.x-i),n=Math.abs(s.y-e);return t>=gi||n>=gi}function St(s,i,e){if(!i)return;const t=s.moves[s.moves.length-2],n=s.moves[s.moves.length-1],r=n.x-s.x,o=n.y-s.y;let a,l=0;t&&(a=n.x-t.x,l=n.y-t.y),Qt(i,"track",{state:s.state,x:e.clientX,y:e.clientY,dx:r,dy:o,ddx:a,ddy:l,sourceEvent:e,hover(){return _s(e.clientX,e.clientY)}})}ct({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown(s){ae(s)&&(this.info.x=s.clientX,this.info.y=s.clientY)},click(s){ae(s)&&mi(this.info,s)},touchstart(s){const i=s.changedTouches[0];this.info.x=i.clientX,this.info.y=i.clientY},touchend(s){mi(this.info,s.changedTouches[0],s)}});function mi(s,i,e){const t=Math.abs(i.clientX-s.x),n=Math.abs(i.clientY-s.y),r=te(e||i);!r||Mr[r.localName]&&r.hasAttribute("disabled")||(isNaN(t)||isNaN(n)||t<=fi&&n<=fi||Fr(i))&&(s.prevent||Qt(r,"tap",{x:i.clientX,y:i.clientY,sourceEvent:i,preventer:e}))}/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ut=s=>class extends Ce(xe(s)){get _activeKeys(){return[" "]}ready(){super.ready(),le(this,"down",e=>{this._shouldSetActive(e)&&this._setActive(!0)}),le(this,"up",()=>{this._setActive(!1)})}disconnectedCallback(){super.disconnectedCallback(),this._setActive(!1)}_shouldSetActive(e){return!this.disabled}_onKeyDown(e){super._onKeyDown(e),this._shouldSetActive(e)&&this._activeKeys.includes(e.key)&&(this._setActive(!0),document.addEventListener("keyup",t=>{this._activeKeys.includes(t.key)&&this._setActive(!1)},{once:!0}))}_setActive(e){this.toggleAttribute("active",e)}};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const qr=["mousedown","mouseup","click","dblclick","keypress","keydown","keyup"],Jt=s=>class extends ut(Wt(ye(s))){constructor(){super(),this.__onInteractionEvent=this.__onInteractionEvent.bind(this),qr.forEach(e=>{this.addEventListener(e,this.__onInteractionEvent,!0)}),this.tabindex=0}get _activeKeys(){return["Enter"," "]}ready(){super.ready(),this.hasAttribute("role")||this.setAttribute("role","button"),this.__shouldAllowFocusWhenDisabled()&&this.style.setProperty("--_vaadin-button-disabled-pointer-events","auto")}_onKeyDown(e){super._onKeyDown(e),!(e.altKey||e.shiftKey||e.ctrlKey||e.metaKey)&&this._activeKeys.includes(e.key)&&(e.preventDefault(),this.click())}__onInteractionEvent(e){this.__shouldSuppressInteractionEvent(e)&&e.stopImmediatePropagation()}__shouldSuppressInteractionEvent(e){return this.disabled}};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const gs=m`
 ...
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class jr extends Jt($(A(w(R(x))))){static get is(){return"vaadin-password-field-button"}static get styles(){return Ur}render(){return y``}}b(jr);/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Gr=m`
 ...
 */class io extends to(A(P(w(R(x))))){static get is(){return"vaadin-text-area"}static get styles(){return[ot,Qr]}render(){return y`
    ...
    `}ready(){super.ready(),this._tooltipController=new Z(this),this._tooltipController.setPosition("top"),this._tooltipController.setAriaTarget(this.inputElement),this.addController(this._tooltipController)}}b(io);/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const so=m`
 ...
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class ro extends vs{static get is(){return"vaadin-integer-field"}constructor(){super(),this.allowedCharPattern="[-+\\d]"}_valueChanged(i,e){if(i!==""&&!this.__isInteger(i)){console.warn(`Trying to set non-integer value "${i}" to <vaadin-integer-field>. Clearing the value.`),this.value="";return}super._valueChanged(i,e)}_stepChanged(i,e){if(i!=null&&!this.__hasOnlyDigits(i)){console.warn(`<vaadin-integer-field> The \`step\` property must be a positive integer but \`${i}\` was provided, so the property was reset to \`null\`.`),this.step=null;return}super._stepChanged(i,e)}__isInteger(i){return/^(-\d)?\d*$/u.test(String(i))}__hasOnlyDigits(i){return/^\d+$/u.test(String(i))}}b(ro);/**
 * @license
 * Copyright (c) 2021 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ms=(s,i=s)=>m`
  ...
  ::slotted(label) {
    ...
    font-weight: var(--vaadin-${C(i)}-font-weight, var(--vaadin-input-field-label-font-weight, 500));
 ...
 */class ho extends lo(P(A(w(R(x))))){static get is(){return"vaadin-checkbox"}static get styles(){return ao}render(){return y`
      ...
      <slot name="tooltip"></slot>
    `}ready(){super.ready(),this._tooltipController=new Z(this),this._tooltipController.setAriaTarget(this.inputElement),this.addController(this._tooltipController)}}b(ho);/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ys=m`
 ...
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class po extends ws(A($(w(R(x))))){static get is(){return"vaadin-select-list-box"}static get styles(){return Es}static get properties(){return{orientation:{readOnly:!0}}}get _scrollerElement(){return this.shadowRoot.querySelector('[part="items"]')}render(){return y`
      <div part="items">
        <slot></slot>
      </div>
    `}ready(){super.ready(),this.setAttribute("role","listbox")}}b(po);/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const fo=m`
 ...
 */class vo extends go(A(w(R(x)))){static get is(){return"vaadin-select-overlay"}static get styles(){return[tt,fo]}render(){return y`
    ...
    `}updated(i){super.updated(i),i.has("renderer")&&this.requestContentUpdate()}}b(vo);/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const mo=m`
 ...
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class bo extends Jt(A(w(R(x)))){static get is(){return"vaadin-select-value-button"}static get styles(){return mo}render(){return y`
 ...
 */class Eo extends wo(P(A(w(R(x))))){static get is(){return"vaadin-select"}static get styles(){return[ot,yo,Co]}render(){return y`
    ...
    `}_onOpenedChanged(i){this.opened=i.detail.value}_onOverlayOpen(){this._menuElement&&this._menuElement.focus({focusVisible:se()})}}b(Eo);window.Vaadin.Flow.selectConnector={};window.Vaadin.Flow.selectConnector.initLazy=s=>{s.$connector||(s.$connector={},s.renderer=i=>{const e=s.querySelector("vaadin-select-list-box");e&&(i.firstChild&&i.removeChild(i.firstChild),i.appendChild(e))})};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const So=Ri(class extends ki{constructor(s){if(super(s),s.type!==J.PROPERTY&&s.type!==J.ATTRIBUTE&&s.type!==J.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Yi(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[i]){if(i===Te||i===Ti)return i;const e=s.element,t=s.name;if(s.type===J.PROPERTY){if(i===e[t])return Te}else if(s.type===J.BOOLEAN_ATTRIBUTE){if(!!i===e.hasAttribute(t))return Te}else if(s.type===J.ATTRIBUTE&&e.getAttribute(t)===i+"")return Te;return Kn(s),i}}),Qe=window;Qe.Vaadin=Qe.Vaadin||{};Qe.Vaadin.setLitRenderer=(s,i,e,t,n,r,o)=>{const a=g=>n.map(E=>(...z)=>{g!==void 0&&t(E,g,z[0]instanceof Event?[]:[...z])}),l=["html","root","live","appId","itemKey","model","item","index",...n,`return html\`${e}\``],h=new Function(...l),_=(g,E,z)=>{const{item:O,index:M}=E;Ft(h(y,g,So,o,z,E,O,M,...a(z)),g)},f=(g,E,z)=>{const{item:O}=z;g.__litRenderer!==f&&(g.innerHTML="",delete g._$litPart$,g.__litRenderer=f);const M={};for(const B in O)B.startsWith(r)&&(M[B.replace(r,"")]=O[B]);_(g,{...z,item:M},O.key)};f.__rendererId=r,s[i]=f};Qe.Vaadin.unsetLitRenderer=(s,i,e)=>{s[i]?.__rendererId===e&&(s[i]=void 0)};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Io=m`
...
`,Ao=[Fe,ms("radio","radio-button"),Io];/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const To=s=>class extends dt(ns(bs(lt(ut(s))))){static get properties(){return{name:{type:String,value:""}}}static get delegateAttrs(){return[...super.delegateAttrs,"name"]}constructor(){super(),this._setType("radio"),this.value="on",this.tabindex=0}get slotStyles(){return[`
          ${this.localName} > input[slot='input'] {
            opacity: 0;
          }
        `]}ready(){super.ready(),this.addController(new at(this,e=>{this._setInputElement(e),this._setFocusElement(e),this.stateTarget=e,this.ariaTarget=e})),this.addController(new $e(this.inputElement,this._labelController))}};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class ko extends To(P(A(w(R(x))))){static get is(){return"vaadin-radio-button"}static get styles(){return Ao}render(){return y`
 ...
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class No extends Jt(P(A(w(R(x))))){static get is(){return"vaadin-button"}static get styles(){return gs}static get properties(){return{disabled:{type:Boolean,value:!1,observer:"_disabledChanged",reflectToAttribute:!0,sync:!0}}}render(){return y`
      <div class="vaadin-button-container">
    ...
    `}ready(){super.ready(),this._tooltipController=new Z(this),this.addController(this._tooltipController)}__shouldAllowFocusWhenDisabled(){return window.Vaadin.featureFlags.accessibleDisabledButtons}}b(No);document.addEventListener("click",s=>{const i=s.composedPath().find(e=>e.hasAttribute&&e.hasAttribute("disableonclick"));i&&(i.disabled=!0)});/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const yi=m`
...
`,Bo=window.Vaadin.featureFlags.layoutComponentImprovements,Vo=m`
 ...
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const qo=s=>class extends s{ready(){super.ready();const i=this.shadowRoot.querySelector("slot:not([name])");this.__startSlotObserver=new ee(i,({currentNodes:n,removedNodes:r})=>{r.length&&this.__clearAttribute(r,"last-start-child");const o=n.filter(l=>l.nodeType===Node.ELEMENT_NODE);this.__updateAttributes(o,"start",!1,!0);const a=n.filter(l=>!es(l));this.toggleAttribute("has-start",a.length>0)});const e=this.shadowRoot.querySelector('[name="end"]');this.__endSlotObserver=new ee(e,({currentNodes:n,removedNodes:r})=>{r.length&&this.__clearAttribute(r,"first-end-child"),this.__updateAttributes(n,"end",!0,!1),this.toggleAttribute("has-end",n.length>0)});const t=this.shadowRoot.querySelector('[name="middle"]');this.__middleSlotObserver=new ee(t,({currentNodes:n,removedNodes:r})=>{r.length&&(this.__clearAttribute(r,"first-middle-child"),this.__clearAttribute(r,"last-middle-child")),this.__updateAttributes(n,"middle",!0,!0),this.toggleAttribute("has-middle",n.length>0)})}__clearAttribute(i,e){const t=i.find(n=>n.nodeType===Node.ELEMENT_NODE&&n.hasAttribute(e));t&&t.removeAttribute(e)}__updateAttributes(i,e,t,n){i.forEach((r,o)=>{if(t){const a=`first-${e}-child`;o===0?r.setAttribute(a,""):r.hasAttribute(a)&&r.removeAttribute(a)}if(n){const a=`last-${e}-child`;o===i.length-1?r.setAttribute(a,""):r.hasAttribute(a)&&r.removeAttribute(a)}})}};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Wo extends qo(A(P(w(R(x))))){static get is(){return"vaadin-horizontal-layout"}static get styles(){return Ho}static get lumoInjector(){return{...super.lumoInjector,includeBaseStyles:!0}}render(){return y`
      <slot></slot>
 ...
 * Copyright (c) 2016 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Ia=s=>class extends s{static get properties(){return{width:{type:String,value:"58px",sync:!0},autoWidth:{type:Boolean,value:!0},flexGrow:{type:Number,value:0,sync:!0},selectAll:{type:Boolean,value:!1,notify:!0,sync:!0},autoSelect:{type:Boolean,value:!1,sync:!0},dragSelect:{type:Boolean,value:!1,sync:!0},_indeterminate:{type:Boolean,sync:!0},_selectAllHidden:Boolean,_shiftKeyDown:{type:Boolean,value:!1}}}static get observers(){return["_onHeaderRendererOrBindingChanged(_headerRenderer, _headerCell, path, header, selectAll, _indeterminate, _selectAllHidden)"]}constructor(){super(),this.__onCellTrack=this.__onCellTrack.bind(this),this.__onCellClick=this.__onCellClick.bind(this),this.__onCellMouseDown=this.__onCellMouseDown.bind(this),this.__onGridInteraction=this.__onGridInteraction.bind(this),this.__onActiveItemChanged=this.__onActiveItemChanged.bind(this),this.__onSelectRowCheckboxChange=this.__onSelectRowCheckboxChange.bind(this),this.__onSelectAllCheckboxChange=this.__onSelectAllCheckboxChange.bind(this)}connectedCallback(){super.connectedCallback(),this._grid&&(this._grid.addEventListener("keyup",this.__onGridInteraction),this._grid.addEventListener("keydown",this.__onGridInteraction,{capture:!0}),this._grid.addEventListener("mousedown",this.__onGridInteraction),this._grid.addEventListener("active-item-changed",this.__onActiveItemChanged))}disconnectedCallback(){super.disconnectedCallback(),this._grid&&(this._grid.removeEventListener("keyup",this.__onGridInteraction),this._grid.removeEventListener("keydown",this.__onGridInteraction,{capture:!0}),this._grid.removeEventListener("mousedown",this.__onGridInteraction),this._grid.removeEventListener("active-item-changed",this.__onActiveItemChanged))}_defaultHeaderRenderer(e,t){let n=e.firstElementChild;n||(n=document.createElement("vaadin-checkbox"),n.accessibleName="Select All",n.classList.add("vaadin-grid-select-all-checkbox"),n.addEventListener("change",this.__onSelectAllCheckboxChange),e.appendChild(n));const r=this.__isChecked(this.selectAll,this._indeterminate);n.checked=r,n.indeterminate=this._indeterminate,n.style.visibility=this._selectAllHidden?"hidden":""}_defaultRenderer(e,t,{item:n,selected:r}){let o=e.firstElementChild;o||(o=document.createElement("vaadin-checkbox"),o.accessibleName="Select Row",o.addEventListener("change",this.__onSelectRowCheckboxChange),e.appendChild(o),le(e,"track",this.__onCellTrack),e.addEventListener("mousedown",this.__onCellMouseDown),e.addEventListener("click",this.__onCellClick)),o.__item=n,o.checked=r;const a=this._grid.__isItemSelectable(n);o.readonly=!a;const l=!a&&!r;o.style.visibility=l?"hidden":""}__onSelectAllCheckboxChange(e){this._indeterminate||e.currentTarget.checked?this._selectAll():this._deselectAll()}__onGridInteraction(e){this._shiftKeyDown=e.shiftKey,this.autoSelect&&this._grid.$.scroller.toggleAttribute("range-selecting",this._shiftKeyDown)}__onSelectRowCheckboxChange(e){this.__toggleItem(e.currentTarget.__item,e.currentTarget.checked)}__onCellTrack(e){if(this.dragSelect)if(this.__dragCurrentY=e.detail.y,this.__dragDy=e.detail.dy,e.detail.state==="start"){const n=this._grid._getRenderedRows().find(r=>r.contains(e.currentTarget.assignedSlot));this.__selectOnDrag=!this._grid._isSelected(n._item),this.__dragStartIndex=n.index,this.__dragStartItem=n._item,this.__dragAutoScroller()}else e.detail.state==="end"&&(this.__dragStartItem&&this.__toggleItem(this.__dragStartItem,this.__selectOnDrag),setTimeout(()=>{this.__dragStartIndex=void 0}))}__onCellMouseDown(e){this.dragSelect&&e.preventDefault()}__onCellClick(e){this.__dragStartIndex!==void 0&&e.preventDefault()}_onCellKeyDown(e){const t=e.composedPath()[0];if(e.keyCode===32){if(t===this._headerCell)this.selectAll?this._deselectAll():this._selectAll();else if(this._cells.includes(t)&&!this.autoSelect){const n=t._content.firstElementChild;this.__toggleItem(n.__item)}}}__onActiveItemChanged(e){const t=e.detail.value;if(this.autoSelect){const n=t||this.__previousActiveItem;n&&this.__toggleItem(n)}this.__previousActiveItem=t}__dragAutoScroller(){if(this.__dragStartIndex===void 0)return;const e=this._grid._getRenderedRows(),t=e.find(l=>{const h=l.getBoundingClientRect();return this.__dragCurrentY>=h.top&&this.__dragCurrentY<=h.bottom});let n=t?t.index:void 0;const r=this.__getScrollableArea();this.__dragCurrentY<r.top?n=this._grid._firstVisibleIndex:this.__dragCurrentY>r.bottom&&(n=this._grid._lastVisibleIndex),n!==void 0&&e.forEach(l=>{(n>this.__dragStartIndex&&l.index>=this.__dragStartIndex&&l.index<=n||n<this.__dragStartIndex&&l.index<=this.__dragStartIndex&&l.index>=n)&&(this.__toggleItem(l._item,this.__selectOnDrag),this.__dragStartItem=void 0)});const o=r.height*.15,a=10;if(this.__dragDy<0&&this.__dragCurrentY<r.top+o){const l=r.top+o-this.__dragCurrentY,h=Math.min(1,l/o);this._grid.$.table.scrollTop-=h*a}if(this.__dragDy>0&&this.__dragCurrentY>r.bottom-o){const l=this.__dragCurrentY-(r.bottom-o),h=Math.min(1,l/o);this._grid.$.table.scrollTop+=h*a}setTimeout(()=>this.__dragAutoScroller(),10)}__getScrollableArea(){const e=this._grid.$.table.getBoundingClientRect(),t=this._grid.$.header.getBoundingClientRect(),n=this._grid.$.footer.getBoundingClientRect();return{top:e.top+t.height,bottom:e.bottom-n.height,left:e.left,right:e.right,height:e.height-t.height-n.height,width:e.width}}_selectAll(){}_deselectAll(){}_selectItem(e){}_deselectItem(e){}__toggleItem(e,t=!this._grid._isSelected(e)){t!==this._grid._isSelected(e)&&(t?this._selectItem(e):this._deselectItem(e))}__isChecked(e,t){return t||e}};class Mt extends Ia(ks){static get is(){return"vaadin-grid-flow-selection-column"}static get properties(){return{autoWidth:{type:Boolean,value:!0},width:{type:String,value:"56px"}}}_defaultHeaderRenderer(i,e){super._defaultHeaderRenderer(i,e);const t=i.firstElementChild;t&&(t.id="selectAllCheckbox")}_selectAll(){this.selectAll=!0,this.$server.selectAll()}_deselectAll(){this.selectAll=!1,this.$server.deselectAll()}_selectItem(i){this.$server.setShiftKeyDown(this._shiftKeyDown),this._grid.$connector.doSelection([i],!0)}_deselectItem(i){this.$server.setShiftKeyDown(this._shiftKeyDown),this._grid.$connector.doDeselection([i],!0),this.selectAll=!1}}customElements.define(Mt.is,Mt);window.Vaadin.Flow.gridConnector={};window.Vaadin.Flow.gridConnector.initLazy=s=>{if(s.$connector)return;const i=s._dataProviderController;let e={};const t=150;let n,r=[0,0];const o=["SINGLE","NONE","MULTI"];let a={},l="SINGLE",h=!1;s.size=0,s.itemIdPath="key",s.$connector={},s.$connector.hasRootRequestQueue=()=>{const{pendingRequests:d}=i.rootCache;return Object.keys(d).length>0||!!n?.isActive()},s.$connector.doSelection=function(d,c){if(l==="NONE"||!d.length||c&&s.hasAttribute("disabled"))return;l==="SINGLE"&&(a={});let u=!1;d.forEach(p=>{const v=!c||s.isItemSelectable(p);u=u||v,p&&v&&(a[p.key]=p,p.selected=!0,c&&s.$server.select(p.key));const T=!s.activeItem||!p||p.key!=s.activeItem.key;!c&&l==="SINGLE"&&T&&(s.activeItem=p)}),u&&(s.selectedItems=Object.values(a))},s.$connector.doDeselection=function(d,c){if(l==="NONE"||!d.length||c&&s.hasAttribute("disabled"))return;const u=s.selectedItems.slice();for(;d.length;){const p=d.shift();if(!c||s.isItemSelectable(p)){for(let T=0;T<u.length;T++){const I=u[T];if(p?.key===I.key){u.splice(T,1);break}}p&&(delete a[p.key],delete p.selected,c&&s.$server.deselect(p.key))}}s.selectedItems=u},s.__activeItemChanged=function(d,c){l=="SINGLE"&&(d?a[d.key]||s.$connector.doSelection([d],!0):c&&a[c.key]&&(s.__deselectDisallowed?s.activeItem=c:(c=i.getItemContext(c).item,s.$connector.doDeselection([c],!0))))},s._createPropertyObserver("activeItem","__activeItemChanged",!0),s.__activeItemChangedDetails=function(d,c){s.__disallowDetailsOnClick||d==null&&c===void 0||(d&&!d.detailsOpened?s.$server.setDetailsVisible(d.key):s.$server.setDetailsVisible(null))},s._createPropertyObserver("activeItem","__activeItemChangedDetails",!0),s.$connector.debounceRootRequest=function(d){const c=s._hasData?t:0;n=S.debounce(n,H.after(c),()=>{s.$connector.fetchPage((u,p)=>s.$server.setViewportRange(u,p),d)})},s.$connector.fetchPage=function(d,c){c=Math.min(c,Math.floor((s.size-1)/s.pageSize));const u=s._getRenderedRows();let p=u.length>0?u[0].index:0,v=u.length>0?u[u.length-1].index:0,T=v-p;p=Math.max(0,p-T),v=Math.min(v+T,s.size);let I=[Math.floor(p/s.pageSize),Math.floor(v/s.pageSize)];if((c<I[0]||c>I[1])&&(I=[c,c]),r[0]!=I[0]||r[1]!=I[1]){r=I;let F=I[1]-I[0]+1;d(I[0]*s.pageSize,F*s.pageSize)}},s.dataProvider=function(d,c){if(d.pageSize!=s.pageSize)throw"Invalid pageSize";let u=d.page;if(s.size===0){c([],0);return}e[u]?c(e[u]):s.$connector.debounceRootRequest(u)},s.$connector.setSorterDirections=function(d){h=!0,setTimeout(()=>{try{const c=Array.from(s.querySelectorAll("vaadin-grid-sorter"));s._sorters.forEach(u=>{c.includes(u)||c.push(u)}),c.forEach(u=>{u.direction=null}),s.multiSortPriority!=="append"&&(d=d.reverse()),d.forEach(({column:u,direction:p})=>{c.forEach(v=>{v.getAttribute("path")===u&&(v.direction=p)})}),s.__applySorters()}finally{h=!1}})};let _=0;function f(d){try{_++,d()}finally{_--}}s.__updateVisibleRows=function(...d){_===0&&Object.getPrototypeOf(this).__updateVisibleRows.call(this,...d)},s.__updateRow=function(d,...c){Object.getPrototypeOf(this).__updateRow.call(this,d,...c),l===o[1]&&(d.removeAttribute("aria-selected"),Array.from(d.children).forEach(u=>u.removeAttribute("aria-selected")))};const g=function(d){if(!d||!Array.isArray(d))throw"Attempted to call itemsUpdated with an invalid value: "+JSON.stringify(d);let c=Array.from(s.detailsOpenedItems);for(let u=0;u<d.length;++u){const p=d[u];p&&(p.detailsOpened?s._getItemIndexInArray(p,c)<0&&c.push(p):s._getItemIndexInArray(p,c)>=0&&c.splice(s._getItemIndexInArray(p,c),1))}s.detailsOpenedItems=c},E=function(d){const{rootCache:c}=i;if(!(e[d]&&c.pendingRequests[d]))for(let u=0;u<s.pageSize;u++){const p=d*s.pageSize+u,v=e[d]?.[u];c.items[p]=v}};s.$connector.set=function(d,c){c.forEach((v,T)=>{const I=d+T,F=Math.floor(I/s.pageSize);e[F]??=[],e[F][I%s.pageSize]=v});const u=Math.floor(d/s.pageSize),p=Math.ceil(c.length/s.pageSize);for(let v=0;v<p;v++)E(u+v);f(()=>{s.$connector.doSelection(c.filter(v=>v.selected)),s.$connector.doDeselection(c.filter(v=>!v.selected&&a[v.key])),g(c)}),s.__updateVisibleRows(d,d+c.length-1)};const z=function(d){for(let c in e)for(let u in e[c])if(s.getItemId(e[c][u])===s.getItemId(d))return{page:c,index:u};return null};s.$connector.updateFlatData=function(d){const c=[];for(let u=0;u<d.length;u++){let p=z(d[u]);if(p){e[p.page][p.index]=d[u];const v=parseInt(p.page)*s.pageSize+parseInt(p.index),{rootCache:T}=i;T.items[v]&&(T.items[v]=d[u]),c.push(v)}}f(()=>{g(d)}),c.forEach(u=>s.__updateVisibleRows(u,u))},s.$connector.clear=function(d,c){if(!e||Object.keys(e).length===0)return;if(d%s.pageSize!=0)throw"Got cleared data for index "+d+" which is not aligned with the page size of "+s.pageSize;let u=Math.floor(d/s.pageSize),p=Math.ceil(c/s.pageSize);for(let v=0;v<p;v++){let T=u+v,I=e[T];I&&(f(()=>{s.$connector.doDeselection(I.filter(F=>a[F.key])),I.forEach(F=>s.closeItemDetails(F))}),delete e[T],E(T))}s.__updateVisibleRows(d,d+c-1)},s.$connector.reset=function(){e={},i.clearCache(),r=[-1,-1],n?.cancel(),s.__updateVisibleRows()},s.$connector.updateSize=d=>s.size=d,s.$connector.updateUniqueItemIdPath=d=>s.itemIdPath=d,s.$connector.confirm=function(d){const{pendingRequests:c}=i.rootCache;Object.entries(c).forEach(([u,p])=>{const v=s.size?Math.ceil(s.size/s.pageSize)-1:0,T=Math.min(r[1],v);e[u]?p(e[u]):u<r[0]||+u>T?(p(new Array(s.pageSize)),s.requestContentUpdate()):p&&s.size===0&&p([])}),Object.keys(c).length===0&&(n?.cancel(),r=[-1,-1]),s.$server.confirmUpdate(d)},s.$connector.setSelectionMode=function(d){if((typeof d=="string"||d instanceof String)&&o.indexOf(d)>=0)l=d,a={},s.selectedItems=[],s.$connector.updateMultiSelectable();else throw"Attempted to set an invalid selection mode"},s.$connector.updateMultiSelectable=function(){s.$&&(l===o[0]?s.$.table.setAttribute("aria-multiselectable",!1):l===o[1]?s.$.table.removeAttribute("aria-multiselectable"):s.$.table.setAttribute("aria-multiselectable",!0))},s._createPropertyObserver("isAttached",()=>s.$connector.updateMultiSelectable());const O=d=>c=>{d&&(d(c),d=null)};s.$connector.setHeaderRenderer=function(d,c){const{content:u,showSorter:p,sorterPath:v}=c;if(u===null){d.headerRenderer=null;return}d.headerRenderer=O(T=>{T.innerHTML="";let I=T;if(p){const F=document.createElement("vaadin-grid-sorter");F.setAttribute("path",v);const U=u instanceof Node?u.textContent:u;U&&F.setAttribute("aria-label",`Sort by ${U}`),T.appendChild(F),I=F}u instanceof Node?I.appendChild(u):I.textContent=u})},s._getActiveSorters=function(){return this._sorters.filter(d=>d.direction)},s.__applySorters=function(...d){const c=s._mapSorters(),u=JSON.stringify(s._previousSorters)!==JSON.stringify(c);s._previousSorters=c,Object.getPrototypeOf(this).__applySorters.call(this,...d),u&&!h&&s.$server.sortersChanged(c)},s.$connector.setFooterRenderer=function(d,c){const{content:u}=c;if(u===null){d.footerRenderer=null;return}d.footerRenderer=O(p=>{p.innerHTML="",u instanceof Node?p.appendChild(u):p.textContent=u})},s.addEventListener("vaadin-context-menu-before-open",function(d){const{key:c,columnId:u}=d.detail;s.$server.updateContextMenuTargetItem(c,u)}),s.getContextMenuBeforeOpenDetail=function(d){const c=d.detail.sourceEvent||d,u=s.getEventContext(c),p=u.item?.key||"",v=u.column?.id||"";return{key:p,columnId:v}},s.preventContextMenu=function(d){const c=d.type==="click",{column:u}=s.getEventContext(d);return c&&u instanceof Mt},s.addEventListener("click",d=>M(d,"item-click")),s.addEventListener("dblclick",d=>M(d,"item-double-click")),s.addEventListener("column-resize",d=>{s._getColumnsInOrder().filter(u=>!u.hidden).forEach(u=>{u.dispatchEvent(new CustomEvent("column-drag-resize"))}),s.dispatchEvent(new CustomEvent("column-drag-resize",{detail:{resizedColumnKey:d.detail.resizedColumn._flowId}}))}),s.addEventListener("column-reorder",d=>{const c=s._columnTree.slice(0).pop().filter(u=>u._flowId).sort((u,p)=>u._order-p._order).map(u=>u._flowId);s.dispatchEvent(new CustomEvent("column-reorder-all-columns",{detail:{columns:c}}))}),s.addEventListener("cell-focus",d=>{const c=s.getEventContext(d);["header","body","footer"].indexOf(c.section)!==-1&&s.dispatchEvent(new CustomEvent("grid-cell-focus",{detail:{itemKey:c.item?c.item.key:null,internalColumnId:c.column?c.column._flowId:null,section:c.section}}))});function M(d,c){if(d.defaultPrevented)return;const u=d.composedPath(),p=u.findIndex(U=>U.localName==="td"||U.localName==="th"),v=u[p];if(u.slice(0,p).some(U=>v?._focusButton!==U&&Os(U)||U instanceof HTMLLabelElement))return;const I=s.getEventContext(d),F=I.section;I.item&&F!=="details"&&(d.itemKey=I.item.key,I.column&&(d.internalColumnId=I.column._flowId),s.dispatchEvent(new CustomEvent(c,{detail:d})))}s.cellPartNameGenerator=function(d,c){const u=c.item.part;if(u)return(u.row||"")+" "+(d&&u[d._flowId]||"")},s.dropFilter=d=>d.item&&!d.item.dropDisabled,s.dragFilter=d=>d.item&&!d.item.dragDisabled,s.addEventListener("grid-dragstart",d=>{s._isSelected(d.detail.draggedItems[0])?(s.__selectionDragData?Object.keys(s.__selectionDragData).forEach(c=>{d.detail.setDragData(c,s.__selectionDragData[c])}):(s.__dragDataTypes||[]).forEach(c=>{d.detail.setDragData(c,d.detail.draggedItems.map(u=>u.dragData[c]).join(`
`))}),s.__selectionDraggedItemsCount>1&&d.detail.setDraggedItemsCount(s.__selectionDraggedItemsCount)):(s.__dragDataTypes||[]).forEach(c=>{d.detail.setDragData(c,d.detail.draggedItems[0].dragData[c])})}),s.isItemSelectable=d=>d?.selectable===void 0||d.selectable;function B(d){const c=d.getBoundingClientRect(),u=s.$.table.getBoundingClientRect(),p=s.$.header.getBoundingClientRect(),v=s.$.footer.getBoundingClientRect();return c.top>=u.top+p.height&&c.bottom<=u.bottom-v.height}s.$connector.scrollToItem=function(d,...c){const u=s._getRenderedRows().find(p=>{const{item:v}=s.__getRowModel(p);return s.getItemId(v)===d});u&&B(u)||s.scrollToIndex(...c)}};/**
 * @license
 * Copyright (c) 2016 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Aa=s=>class extends Ts(s){static get properties(){return{_childColumns:{value(){return this._getChildColumns(this)}},flexGrow:{type:Number,readOnly:!0,sync:!0},width:{type:String,readOnly:!0,sync:!0},_visibleChildColumns:Array,_colSpan:Number,_rootColumns:Array}}static get observers(){return["_groupFrozenChanged(frozen, _rootColumns)","_groupFrozenToEndChanged(frozenToEnd, _rootColumns)","_groupHiddenChanged(hidden)","_colSpanChanged(_colSpan, _headerCell, _footerCell)","_groupOrderChanged(_order, _rootColumns)","_groupReorderStatusChanged(_reorderStatus, _rootColumns)","_groupResizableChanged(resizable, _rootColumns)"]}connectedCallback(){super.connectedCallback(),this._addNodeObserver(),this._updateFlexAndWidth()}disconnectedCallback(){super.disconnectedCallback(),this._observer&&this._observer.disconnect()}_columnPropChanged(i,e){i==="hidden"&&(this._preventHiddenSynchronization=!0,this._updateVisibleChildColumns(this._childColumns),this._preventHiddenSynchronization=!1),/flexGrow|width|hidden|_childColumns/u.test(i)&&this._updateFlexAndWidth(),i==="frozen"&&!this.frozen&&(this.frozen=e),i==="lastFrozen"&&!this._lastFrozen&&(this._lastFrozen=e),i==="frozenToEnd"&&!this.frozenToEnd&&(this.frozenToEnd=e),i==="firstFrozenToEnd"&&!this._firstFrozenToEnd&&(this._firstFrozenToEnd=e)}_groupOrderChanged(i,e){if(e){const t=e.slice(0);if(!i){t.forEach(a=>{a._order=0});return}const n=/(0+)$/u.exec(i).pop().length,r=~~(Math.log(e.length)/Math.LN10)+1,o=10**(n-r);t[0]&&t[0]._order&&t.sort((a,l)=>a._order-l._order),As(t,o,i)}}_groupReorderStatusChanged(i,e){i===void 0||e===void 0||e.forEach(t=>{t._reorderStatus=i})}_groupResizableChanged(i,e){i===void 0||e===void 0||e.forEach(t=>{t.resizable=i})}_updateVisibleChildColumns(i){this._visibleChildColumns=Array.prototype.filter.call(i,e=>!e.hidden),this._colSpan=this._visibleChildColumns.length,this._updateAutoHidden()}_updateFlexAndWidth(){if(this._visibleChildColumns){if(this._visibleChildColumns.length>0){const i=this._visibleChildColumns.reduce((e,t)=>(e+=` + ${(t.width||"0px").replace("calc","")}`,e),"").substring(3);this._setWidth(`calc(${i})`)}else this._setWidth("0px");this._setFlexGrow(Array.prototype.reduce.call(this._visibleChildColumns,(i,e)=>i+e.flexGrow,0))}}__scheduleAutoFreezeWarning(i,e){if(this._grid){const t=e.replace(/([A-Z])/gu,"-$1").toLowerCase(),n=i[0][e]||i[0].hasAttribute(t);i.every(o=>(o[e]||o.hasAttribute(t))===n)||(this._grid.__autoFreezeWarningDebouncer=S.debounce(this._grid.__autoFreezeWarningDebouncer,Y,()=>{console.warn(`WARNING: Joining ${e} and non-${e} Grid columns inside the same column group! This will automatically freeze all the joined columns to avoid rendering issues. If this was intentional, consider marking each joined column explicitly as ${e}. Otherwise, exclude the ${e} columns from the joined group.`)}))}}_groupFrozenChanged(i,e){e===void 0||i===void 0||i!==!1&&(this.__scheduleAutoFreezeWarning(e,"frozen"),Array.from(e).forEach(t=>{t.frozen=i}))}_groupFrozenToEndChanged(i,e){e===void 0||i===void 0||i!==!1&&(this.__scheduleAutoFreezeWarning(e,"frozenToEnd"),Array.from(e).forEach(t=>{t.frozenToEnd=i}))}_groupHiddenChanged(i){(i||this.__groupHiddenInitialized)&&this._synchronizeHidden(),this.__groupHiddenInitialized=!0}_updateAutoHidden(){const i=this._autoHidden;this._autoHidden=(this._visibleChildColumns||[]).length===0,(i||this._autoHidden)&&(this.hidden=this._autoHidden)}_synchronizeHidden(){this._childColumns&&!this._preventHiddenSynchronization&&this._childColumns.forEach(i=>{i.hidden=this.hidden})}_colSpanChanged(i,e,t){e&&(e.setAttribute("colspan",i),this._grid&&this._grid.__a11yUpdateCellColspan(e,i)),t&&(t.setAttribute("colspan",i),this._grid&&this._grid.__a11yUpdateCellColspan(t,i))}_getChildColumns(i){return ie.getColumns(i)}_addNodeObserver(){this._observer=new ie(this,()=>{this._preventHiddenSynchronization=!0,this._rootColumns=this._getChildColumns(this),this._childColumns=this._rootColumns,this._updateVisibleChildColumns(this._childColumns),this._preventHiddenSynchronization=!1,this._grid&&this._grid._debounceUpdateColumnTree&&this._grid._debounceUpdateColumnTree()}),this._observer.flush()}_isColumnElement(i){return i.nodeType===Node.ELEMENT_NODE&&/\bcolumn\b/u.test(i.localName)}};/**
 * @license
 * Copyright (c) 2016 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Ta extends Aa(w(x)){static get is(){return"vaadin-grid-column-group"}}b(Ta);/**
 * @license
 * Copyright (c) 2016 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */ct({name:"vaadin-contextmenu",deps:["touchstart","touchmove","touchend","contextmenu"],flow:{start:["touchstart","contextmenu"],end:["contextmenu"]},emits:["vaadin-contextmenu"],info:{sourceEvent:null},reset(){this.info.sourceEvent=null,this._cancelTimer(),this.info.touchJob=null,this.info.touchStartCoords=null},_cancelTimer(){this._timerId&&(clearTimeout(this._timerId),delete this._fired)},_setSourceEvent(s){this.info.sourceEvent=s;const i=s.composedPath();this.info.sourceEvent.__composedPath=i},touchstart(s){this._setSourceEvent(s),this.info.touchStartCoords={x:s.changedTouches[0].clientX,y:s.changedTouches[0].clientY};const i=s.composedPath()[0]||s.target;this._timerId=setTimeout(()=>{const e=s.changedTouches[0];s.shiftKey||(ve&&(this._fired=!0,this.fire(i,e.clientX,e.clientY)),me("tap"))},500)},touchmove(s){const e=this.info.touchStartCoords;(Math.abs(e.x-s.changedTouches[0].clientX)>15||Math.abs(e.y-s.changedTouches[0].clientY)>15)&&this._cancelTimer()},touchend(s){this._fired&&s.preventDefault(),this._cancelTimer()},contextmenu(s){if(!s.shiftKey){if(this._setSourceEvent(s),qi&&se()){const i=s.composedPath()[0],e=i.getBoundingClientRect();this.fire(i,e.left,e.bottom)}else this.fire(s.target,s.clientX,s.clientY);me("tap")}},fire(s,i,e){const t=this.info.sourceEvent,n=new Event("vaadin-contextmenu",{bubbles:!0,cancelable:!0,composed:!0});n.detail={x:i,y:e,sourceEvent:t},s.dispatchEvent(n),n.defaultPrevented&&t&&t.preventDefault&&t.preventDefault()}});/**
 * @license
 * Copyright (c) 2016 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ka=m`
 ...
 * Copyright (c) 2016 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class Oa extends Cs(A($(w(R(x))))){static get is(){return"vaadin-context-menu-item"}static get styles(){return Ra}render(){return y`
      <span part="checkmark" aria-hidden="true"></span>
      <div part="content">
        <slot></slot>
      </div>
    `}ready(){super.ready(),this.setAttribute("role","menuitem")}}b(Oa);/**
 * @license
 * Copyright (c) 2016 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class za extends ws(A($(w(R(x))))){static get is(){return"vaadin-context-menu-list-box"}static get styles(){return Es}static get properties(){return{orientation:{type:String,readOnly:!0}}}get _scrollerElement(){return this.shadowRoot.querySelector('[part="items"]')}render(){return y`
      <div part="items">
        <slot></slot>
      </div>
    `}ready(){super.ready(),this.setAttribute("role","menu")}}b(za);/**
 * @license
 * Copyright (c) 2016 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const La=m`
 ...
 */class Ba extends Na(P(Pe(w(x)))){static get is(){return"vaadin-context-menu"}static get styles(){return m`
    ...
    `}__computeHorizontalAlign(i){return i&&["top-end","bottom-end","start-top","start","start-bottom"].includes(i)?"end":"start"}__computeNoHorizontalOverlap(i){return i?["start-top","start","start-bottom","end-top","end","end-bottom"].includes(i):!!this._positionTarget}__computeNoVerticalOverlap(i){return i?["top-start","top-end","top","bottom-start","bottom","bottom-end"].includes(i):!1}__computeVerticalAlign(i){return i&&["top-start","top-end","top","start-bottom","end-bottom"].includes(i)?"bottom":"top"}}b(Ba);function Va(s,i){try{return window.Vaadin.Flow.clients[s].getByNodeId(i)}catch(e){console.error("Could not get node %s from app %s",i,s),console.error(e)}}function Ha(s,i){s.$connector||(s.$connector={generateItems(e){const t=ti(i,e);s.items=t}})}function ti(s,i){const e=Va(s,i);if(e)return Array.from(e.children).map(t=>{const n={component:t,checked:t._checked,keepOpen:t._keepOpen,className:t.className,theme:t.__theme};return t._hasVaadinItemMixin&&t._containerNodeId&&(n.children=ti(s,t._containerNodeId)),t._item=n,n})}function qa(s,i){s._item&&(s._item.checked=i,s._item.keepOpen&&s.toggleAttribute("menu-item-checked",i))}function Wa(s,i){s._item&&(s._item.keepOpen=i)}function Ua(s,i){s._item&&(s._item.theme=i)}window.Vaadin.Flow.contextMenuConnector={initLazy:Ha,generateItemsTree:ti,setChecked:qa,setKeepOpen:Wa,setTheme:Ua};function ja(s){s.$contextMenuTargetConnector||(s.$contextMenuTargetConnector={openOnHandler(i){if(s.preventContextMenu&&s.preventContextMenu(i))return;i.preventDefault(),i.stopPropagation(),this.$contextMenuTargetConnector.openEvent=i;let e={};s.getContextMenuBeforeOpenDetail&&(e=s.getContextMenuBeforeOpenDetail(i)),s.dispatchEvent(new CustomEvent("vaadin-context-menu-before-open",{detail:e}))},updateOpenOn(i){this.removeListener(),this.openOnEventType=i,customElements.whenDefined("vaadin-context-menu").then(()=>{X[i]?le(s,i,this.openOnHandler):s.addEventListener(i,this.openOnHandler)})},removeListener(){this.openOnEventType&&(X[this.openOnEventType]?fs(s,this.openOnEventType,this.openOnHandler):s.removeEventListener(this.openOnEventType,this.openOnHandler))},openMenu(i){i.open(this.openEvent)},removeConnector(){this.removeListener(),s.$contextMenuTargetConnector=void 0}})}window.Vaadin.Flow.contextMenuTargetConnector={init:ja};/**
 * @license
 * Copyright (c) 2017 - 2026 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Ga=m`
 ...
 */class Qa extends Xa(A(P(w(R(x))))){static get is(){return"vaadin-notification-container"}static get styles(){return Ka}render(){return y`
    ...
    `}}class Ja extends A(w(R(x))){static get is(){return"vaadin-notification-card"}static get styles(){return Ga}render(){return y`
      <div part="overlay">
        <div part="content">
          <slot></slot>
        </div>
      </div>
    `}ready(){super.ready(),this.setAttribute("role","alert")}}class el extends Za(P(A(w(x)))){static get is(){return"vaadin-notification"}static get styles(){return m`
      :host {
        display: none !important;
      }
    `}render(){return y`
      ...
      ></vaadin-notification-card>
    `}}b(Qa);b(Ja);b(el);function tl(s,i){if(i.type==="stateKeyChanged"){const{value:e}=i;return{...s,key:e}}else return s}const il=()=>{};class sl extends HTMLElement{#e=void 0;#i=!1;#t=void 0;#s=Object.create(null);#r=new Map;#n=new Map;#o=il;#d=new Map;#h;#a;#l;constructor(){super(),this.#h={useState:this.useState.bind(this),useCustomEvent:this.useCustomEvent.bind(this),useContent:this.useContent.bind(this)},this.#a=this.#u.bind(this),this.#_()}async connectedCallback(){this.#t=we.createElement(this.#a),!(!this.dispatchEvent(new CustomEvent("flow-portal-add",{bubbles:!0,cancelable:!0,composed:!0,detail:{children:this.#t,domNode:this}}))||this.#e)&&(await this.#l,this.#e=Ns.createRoot(this),this.#c(),this.#e.render(this.#t))}addReadyCallback(i,e){this.#d.set(i,e)}async disconnectedCallback(){this.#e?(this.#l=Promise.resolve(),await this.#l,this.#e.unmount(),this.#e=void 0):this.dispatchEvent(new CustomEvent("flow-portal-remove",{bubbles:!0,cancelable:!0,composed:!0,detail:{children:this.#t,domNode:this}})),this.#i=!1,this.#t=void 0}useState(i,e){if(this.#r.has(i))return[this.#s[i],this.#r.get(i)];const t=this[i]??e;this.#s[i]=t,Object.defineProperty(this,i,{enumerable:!0,get(){return this.#s[i]},set(o){this.#s[i]=o,this.#o({type:"stateKeyChanged",key:i,value:t})}});const n=this.useCustomEvent(`${i}-changed`,{detail:{value:t}}),r=o=>{this.#s[i]=o,n({value:o}),this.#o({type:"stateKeyChanged",key:i,value:o})};return this.#r.set(i,r),[t,r]}useCustomEvent(i,e={}){if(!this.#n.has(i)){const t=(n=>{const r=n===void 0?e:{...e,detail:n},o=new CustomEvent(i,r);return this.dispatchEvent(o)});return this.#n.set(i,t),t}return this.#n.get(i)}useContent(i){return we.useEffect(()=>{this.#d.get(i)?.()},[]),we.createElement("flow-content-container",{name:i,style:{display:"contents"}})}#c(){this.#i||!this.#e||(this.#e.render(we.createElement(this.#a)),this.#i=!0)}#u(){const[i,e]=we.useReducer(tl,this.#s);return this.#s=i,this.#o=e,this.render(this.#h)}#_(){let i=window.Vaadin||{};i.developmentMode&&(i.registrations=i.registrations||[],i.registrations.push({is:"ReactAdapterElement",version:"25.0.5"}))}}class nl extends sl{async connectedCallback(){await super.connectedCallback(),this.style.display="contents"}render(){return Bs.jsx(Vs,{})}}customElements.define("react-router-outlet",nl);const rl=s=>Promise.resolve(0);window.Vaadin=window.Vaadin||{};window.Vaadin.Flow=window.Vaadin.Flow||{};window.Vaadin.Flow.loadOnDemand=rl;window.Vaadin.Flow.resetFocus=()=>{let s=document.activeElement;for(;s&&s.shadowRoot;)s=s.shadowRoot.activeElement;return!s||s.blur()||s.focus()||!0};
