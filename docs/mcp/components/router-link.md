...
**Category:** Navigation | Client-side navigation link

## Constructor

```python
RouterLink(text: str = "", href: str = "")
```
...
| `get_href() -> str` | Get the link href. |
...
| `get_text() -> str` | Get the link text. |
...
| `set_href(href: str)` | Set the link href. |
...
| `set_text(text: str)` | Set the link text. |
