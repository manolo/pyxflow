...
**Category:** Input | Dropdown selection (single value)
...
| `add_theme_variants(*variants: pyxflow.components.constants.SelectVariant)` | Add theme variants to the select. |
...
| `get_value() -> ~T | None` | Get the selected value. |
| `get_width() -> 'str | None'` |  |
...
| `is_empty_selection_allowed() -> bool` |  |
...
| `remove_theme_variants(*variants: pyxflow.components.constants.SelectVariant)` | Remove theme variants from the select. |
...
| `set_empty_selection_allowed(allowed: bool)` | Set whether empty (no) selection is allowed. |
| `set_empty_selection_caption(caption: str)` | Set the caption shown when no value is selected. |
...
| `set_items(*items: ~T)` | Set the items for the select. |
...
| `set_prefix_component(component: pyxflow.core.component.Component)` | Set a prefix component (e.g. an Icon). |
...
| `set_value(value: ~T | None)` | Set the selected value. |
