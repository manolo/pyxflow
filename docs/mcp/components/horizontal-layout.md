...
**Category:** Layout | Horizontal flex container with spacing

## Constructor

```python
HorizontalLayout(children: Component)
```
...
| `add_theme_variants(*variants: pyxflow.components.constants.HorizontalLayout...` | Add theme variants to the horizontal layout. |
...
| `remove_theme_variants(*variants: pyxflow.components.constants.HorizontalLayout...` | Remove theme variants from the horizontal layout. |
...
| `set_box_sizing(box_sizing: str)` | Set box-sizing ('border-box' or 'content-box'). |
| `set_class_name(class_name: 'str', add: 'bool' = True)` | Add or remove a CSS class name. |
| `set_default_vertical_component_alignment(alignment: pyxflow.components.constants.Alignment)` | Set default vertical alignment for all children. |
| `set_enabled(enabled: 'bool')` | Set the enabled state of the component. |
| `set_flex_grow(flex_grow: float, *components: pyxflow.core.component.Co...` | Set flex-grow for specific components. |
| `set_flex_shrink(flex_shrink: float, *components: pyxflow.core.component....` | Set flex-shrink for specific components. |
...
| `set_vertical_component_alignment(alignment: pyxflow.components.constants.Alignment, *comp...` | Set vertical alignment for specific components. |
