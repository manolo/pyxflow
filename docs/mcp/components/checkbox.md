...
**Category:** Input | Single checkbox toggle
...
**Mixins:** HasReadOnly, HasRequired

Mixin methods: `set_read_only(bool)`, `is_read_only()`, `set_required_indicator_visible(bool)`, `is_required_indicator_visible()`
...
| `add_theme_variants(*variants: pyxflow.components.constants.CheckboxVariant)` | Add theme variants to the checkbox. |
| `add_value_change_listener(listener: Callable)` | Add a listener for value changes. |
...
| `get_value() -> bool` | Get the checked state. |
| `get_width() -> 'str | None'` |  |
...
| `is_indeterminate() -> bool` | Get the indeterminate state. |
...
| `remove_theme_variants(*variants: pyxflow.components.constants.CheckboxVariant)` | Remove theme variants from the checkbox. |
...
| `set_indeterminate(indeterminate: bool)` | Set the indeterminate state. |
...
| `set_value(value: bool)` | Set the checked state. |
