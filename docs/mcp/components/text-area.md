...
**Category:** Input | Multi-line text input
...
| `add_theme_variants(*variants: pyxflow.components.constants.TextAreaVariant)` | Add theme variants to the text area. |
...
| `remove_theme_variants(*variants: pyxflow.components.constants.TextAreaVariant)` | Remove theme variants from the text area. |
...
| `set_max_height(max_height: str | None)` | Set maximum height (e.g., '200px'). |
| `set_max_length(max_length: int)` | Set the maximum number of characters. |
| `set_max_rows(max_rows: int)` | Set the maximum number of visible rows. |
| `set_max_width(max_width: 'str | None')` |  |
| `set_min_height(min_height: str | None)` | Set minimum height (e.g., '100px'). |
| `set_min_length(min_length: int)` | Set the minimum number of characters. |
| `set_min_rows(min_rows: int)` | Set the minimum number of visible rows. |
