...
**Category:** Display | Markdown renderer
...
| `append_content(content: str)` | Append content to the existing markdown content. |
...
| `set_content(content: str)` | Set the markdown content. |
