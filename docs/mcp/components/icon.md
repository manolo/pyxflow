...
**Category:** Display | Vaadin/Lumo icon
...
| `set_color(color: str)` | Set the icon color via CSS fill. |
...
| `set_icon(icon: str)` | Set the icon (e.g., 'vaadin:home' or 'home'). |
...
| `set_size(size: str)` | Set the icon size (width and height). |
