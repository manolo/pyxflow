...
**Category:** Layout | Collapsible content panel

## Constructor

```python
Details(summary: str | Component | None = None, content: Component)
```
...
| `remove(*components: pyxflow.core.component.Component)` | Remove specific content components. |
| `remove_all()` | Remove all content components. |
