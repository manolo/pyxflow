...
**Category:** Layout | Application shell with navbar/drawer
...
| `add_to_drawer(*components: pyxflow.core.component.Component)` | Add components to the drawer area. |
| `add_to_navbar(*components: pyxflow.core.component.Component)` | Add components to the navbar area. |
...
| `get_content() -> pyxflow.core.component.Component | None` |  |
...
| `get_primary_section() -> pyxflow.components.constants.AppLayoutSection` | Get which section is primary. |
...
| `is_drawer_opened() -> bool` | Check if the drawer is open. |
...
| `remove_router_layout_content(old: pyxflow.core.component.Component)` | Called by the router to remove the previous routed view. |
...
| `set_content(component: pyxflow.core.component.Component)` | Set the content area (replaces previous content). |
| `set_drawer_opened(opened: bool)` | Open or close the drawer. |
...
| `set_primary_section(section: 'AppLayoutSection | str')` | Set which section is primary (Section.NAVBAR or Section.DRAWER). |
...
| `show_router_layout_content(content: pyxflow.core.component.Component)` | Called by the router to set the routed view as content. |
