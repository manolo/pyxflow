...
**Category:** Display | Group of overlapping avatars
...
| Method | Description |
|--------|-------------|
| `add(*items: pyxflow.components.avatar.AvatarGroupItem)` | Add items to the group. |
...
| `add_theme_variants(*variants: pyxflow.components.constants.AvatarGroupVariant)` | Add theme variants to the avatar group. |
...
| `get_items() -> list[pyxflow.components.avatar.AvatarGroupItem]` |  |
| `get_max_height() -> 'str | None'` |  |
| `get_max_items_visible() -> int | None` |  |
...
| `remove_theme_variants(*variants: pyxflow.components.constants.AvatarGroupVariant)` | Remove theme variants from the avatar group. |
...
| `set_items(items: list[pyxflow.components.avatar.AvatarGroupItem])` | Replace all items. |
| `set_max_height(max_height: 'str | None')` |  |
| `set_max_items_visible(max_visible: int)` | Set the maximum number of avatars visible before overflow. |
...
```python
AvatarGroupItem(name: str = "", abbr: str = "", img: str = "", color_index: Union = None)
```
