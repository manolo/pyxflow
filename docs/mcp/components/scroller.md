...
**Category:** Layout | Scrollable content container

## Constructor

```python
Scroller(children: Component, scroll_direction: ScrollDirection = "ScrollDirection.BOTH")
```
...
| Method | Description |
|--------|-------------|
| `add(*components: pyxflow.core.component.Component)` | Add components to the scroller. |
...
| `add_theme_variants(*variants: pyxflow.components.constants.ScrollerVariant)` | Add theme variants to the scroller. |
...
| `get_content() -> pyxflow.core.component.Component | None` | Get the first content component, or None. |
...
| `get_scroll_direction() -> pyxflow.components.constants.ScrollDirection` |  |
...
| `remove_theme_variants(*variants: pyxflow.components.constants.ScrollerVariant)` | Remove theme variants from the scroller. |
...
| `set_content(component: pyxflow.core.component.Component)` | Set a single component as content (replaces all children). |
...
| `set_scroll_direction(direction: pyxflow.components.constants.ScrollDirection)` | Set the scroll direction. |
