...
from pyxflow.components.constants import UploadVariant
from pyxflow.server.uidl_handler import (
...
class Upload(Component):
    ...
    def _attach(self, tree: "StateTree"):
        ...
        from pyxflow.server.http_server import register_upload_handler, _sessions
