...
**Lines of code:** ~18,100 (core src/), ~55,300 (total with demo + tests)
**Test structure:** `tests/unit/` (2415 unit tests, default `pytest`) + `tests/ui/` (446 Playwright, run explicitly)
**Tests:** 2415 unit + 446 UI (Playwright)
