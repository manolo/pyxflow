...
class ComponentsDemoView(VerticalLayout):
    def __init__(self):
        ...
        context_target.get_style().set("padding", "var(--vaadin-padding-s)")
        context_target.get_style().set("background", "var(--vaadin-background-container)")
        context_target.get_style().set("border-radius", "var(--vaadin-radius-m)")
...
""")
        ...
        integer_field.set_step_buttons_visible(True)
        ...
        number.get_style().set("flex-grow", "1")
        ...
        self.upload_gallery.get_style().set("gap", "var(--vaadin-gap-m)")
        ...
        header_div.get_style().set("background-color", "var(--vaadin-background-container-strong)")
        header_div.get_style().set("color", "var(--vaadin-text-color)")
        header_div.get_style().set("display", "flex")
        header_div.get_style().set("align-items", "center")
        header_div.get_style().set("justify-content", "center")

        footer_div = Footer("Footer")
        footer_div.set_width("100%")
        footer_div.set_height("50px")
        footer_div.get_style().set("background-color", "var(--vaadin-background-container-strong)")
        footer_div.get_style().set("color", "var(--vaadin-text-color)")
        footer_div.get_style().set("display", "flex")
        footer_div.get_style().set("align-items", "center")
        footer_div.get_style().set("justify-content", "center")

        nav_div = Div("Navigation")
        nav_div.set_width("25%")
        nav_div.get_style().set("background-color", "var(--vaadin-background-container)")
        nav_div.get_style().set("display", "flex")
        nav_div.get_style().set("align-items", "center")
        nav_div.get_style().set("justify-content", "center")

        content_div = Div("Content")
        content_div.set_width("75%")
        content_div.get_style().set("background-color", "var(--vaadin-background-color)")
        content_div.get_style().set("color", "var(--vaadin-text-color)")
        content_div.get_style().set("display", "flex")
        content_div.get_style().set("align-items", "center")
        content_div.get_style().set("justify-content", "center")
    ...
    def on_upload_received(self, filename, mime_type, data):
        ...
        title_div.get_style().set("overflow", "hidden")
        title_div.get_style().set("text-overflow", "ellipsis")
        title_div.get_style().set("white-space", "nowrap")
