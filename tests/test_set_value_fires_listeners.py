...
class TestEmailFieldSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import EmailField
        ef = EmailField()
        events = []
...
class TestPasswordFieldSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import PasswordField
        pf = PasswordField()
        events = []
...
class TestNumberFieldSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import NumberField
        nf = NumberField()
        events = []
...
class TestIntegerFieldSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import IntegerField
        f = IntegerField()
        events = []
...
class TestDatePickerSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import DatePicker
        dp = DatePicker()
        events = []
...
class TestTimePickerSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import TimePicker
        tp = TimePicker()
        events = []
...
class TestListBoxSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import ListBox
        lb = ListBox()
        lb.set_items("A", "B", "C")
        events = []
...
class TestMultiSelectListBoxSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components.list_box import MultiSelectListBox
...
class TestSelectSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import Select
        s = Select()
        s.set_items("X", "Y", "Z")
        events = []
...
class TestComboBoxSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import ComboBox
        cb = ComboBox()
...
class TestMultiSelectComboBoxSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import MultiSelectComboBox
...
class TestCheckboxSetValueFiresListeners:
    def test_set_checked_fires_listener(self):
        from vaadin.flow.components import Checkbox
        cb = Checkbox("Accept")
        events = []
        cb.add_value_change_listener(lambda e: events.append(e))
        cb.set_checked(True)
...
class TestCheckboxGroupSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import CheckboxGroup
        cg = CheckboxGroup()
        cg.set_items("A", "B", "C")
        events = []
...
class TestRadioButtonGroupSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import RadioButtonGroup
        rg = RadioButtonGroup()
        rg.set_items("X", "Y", "Z")
        events = []
...
class TestCustomFieldSetValueFiresListeners:
    def test_fires_listener(self):
        from vaadin.flow.components import CustomField
        cf = CustomField()
        events = []
