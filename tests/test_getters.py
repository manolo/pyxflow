...
class TestTabsGetters:
    def test_is_autoselect_default(self):
        from vaadin.flow.components import Tabs
        tabs = Tabs()
    ...
    def test_get_orientation_after_set(self):
        from vaadin.flow.components import Tabs, Tab
        tabs = Tabs(Tab("A"))
        tree = StateTree()
        tabs._attach(tree)
...
class TestTabSheetGetters:
    def test_get_tab_count(self):
        from vaadin.flow.components import TabSheet
    ...
    def test_get_index_of_unknown_tab(self):
        from vaadin.flow.components import TabSheet
        from vaadin.flow.components.tabs import Tab
        ts = TabSheet()
...
class TestAppLayoutGetters:
    def test_get_primary_section_default(self):
        from vaadin.flow.components import AppLayout
        layout = AppLayout()
...
class TestContextMenuGetters:
    def test_get_target(self):
        from vaadin.flow.components import ContextMenu
        from vaadin.flow.components.html import Div
        target = Div("Click me")
...
class TestCardGetters:
    def test_get_media(self):
        from vaadin.flow.components import Card
        from vaadin.flow.components.html import Div
        media = Div("img")
        card = Card()
    ...
    def test_get_header_prefix(self):
        from vaadin.flow.components import Card, Icon
...
class TestScrollerGetters:
    def test_get_content(self):
        from vaadin.flow.components import Scroller
        from vaadin.flow.components.html import Div
        content = Div("Content")
...
class TestSideNavGetters:
    def test_is_collapsible_default(self):
        from vaadin.flow.components import SideNav
        nav = SideNav()
...
class TestSideNavItemGetters:
    def test_is_expanded_default(self):
        from vaadin.flow.components import SideNavItem
...
class TestIconGetters:
    def test_get_color_default(self):
        from vaadin.flow.components import Icon
        icon = Icon("home")
...
class TestDialogCloseProperties:
    def test_close_on_esc_default(self):
        from vaadin.flow.components import Dialog
        dlg = Dialog()
